                            ...
                            <div class="card-body p-5">
                                ...
                                <form method="POST" class="needs-validation" novalidate="" autocomplete="off">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="txt_std_fname" class="form-control" required placeholder="">
                                        </div>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="mb-2 text-muted" for="std_lname">สกุล</label>
                                        <div class="col-sm-12">
                                            <input type="text" name="txt_std_lname" class="form-control" required placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="txt_std_id" class="form-control" required placeholder="">
                                        </div>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="mb-2 text-muted" for="major">สาขาวิชา</label>
                                        <select name="txt_major" class="form-select" aria-label="Default select example">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="mb-2 w-100">
                                            ...
                                            <input type="password" name="txt_password" class="form-control" required placeholder="">
                                        </div>
                                    </div> <br>
