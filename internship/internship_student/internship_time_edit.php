        ...
        <div class="page-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../internship_student/time_detail.php">รายละเอียดบันทึกการฝึกงาน</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขบันทึกการฝึกงาน</li>
                </ol>
            </nav>
            <!-- ส่วนของข้อมูล -->
            <div class="content container-fluid">
                ...
                <form action="./internship_time_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="formFile" name="internship_time_file" required>
                    </div>
