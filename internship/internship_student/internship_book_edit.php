        ...
        <div class="page-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../internship_student/internship_book_detail.php">รายละเอียดใบยินยอมจากผู้ปกครอง</a></li>
            ...
            <div class="content container-fluid">
                ...
                <form action="./internship_book_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="formFile" name="internship_book_file" required>
                    </div>
