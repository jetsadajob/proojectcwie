...
<head>
    ...
    <title>หนังสือยินยอมผู้ปกครอง</title>
        ...
        <div class="page-wrapper">
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="../internship_student/internship_student_home.php">แบบฟอร์มฝึกงาน</a></li>
                    <li class="breadcrumb-item active" aria-current="page">หนังสือยินยอมผู้ปกครอง</li>
                </ol>
            </nav>
            <div class="content container-fluid">
                ...
                <form action="./internship_book_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <!-- <hr> -->
                    <div class="mb-3">
                        <label for="formFile" class="form-label">แนบไฟล์</label>
                        <input class="form-control" type="file" id="formFile" name="internship_parental_file" required>
                    </div>
