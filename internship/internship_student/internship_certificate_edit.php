        ...
        <div class="page-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../internship_student/certificate_detail.php">รายละเอียดใบรับรองการฝึกงาน</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขใบรับรองการฝึกงาน</li>
                </ol>
            </nav>
            <div class="content container-fluid">
                ...
                <div class="fw-semibold text-center">
                    ใบรับรองการฝึกงาน<br>
                </div>

                <form action="./internship_certificate_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="formFile" class="form-label">แนบไฟล์</label>
                        <input class="form-control" type="file" id="formFile" name="internship_certificate_file" required>
                    </div>
