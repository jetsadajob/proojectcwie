    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <form class="row g-3 needs-validation" action="./internship_information_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="p-3 py-5">
                                    ...
                                    <div class="row mt-6">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputtext" placeholder="รหัสนักศึกษา" name="std_id" value="<?php echo isset($row['std_id']) ? $row['std_id'] : ''; ?>" required>
                                        </div>
                                        <div class="col-md-6">
