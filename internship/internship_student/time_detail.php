...
if ($row = mysqli_fetch_assoc($result)) {
    ...
    $sql = "SELECT * FROM internship_time WHERE email = '$email'";
    $result = mysqli_query($conn, $sql);
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                        ...
                        <a href="./internship_time_edit.php"><button class="btn btn-warning" style="border-radius: 7px;"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <div class="box-body">
                    <form id="w1" class="form-vertical" action="./internship_book_update.php" method="post" role="form">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <div class="kv-attribute"><a href="../uploads/<?php echo $row1['internship_time_file']; ?>" target="_blank" style=" color: #0d6efd;"><?php echo basename($row1['internship_time_file']); ?></a></div>
                            </div>
                        </div>
                    </form>
                </div>
