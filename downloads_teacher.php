    ...
    <main class="container">
        ...
        <div class="con1 row mb-2">
                ...
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <a type="button" class="btn btn-primary p-2 p-md- mb-4 "
                            style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" href="downloads_student.php">
                            <i class="bi bi-list-task"></i> สำหรับนักศึกษา
                        </a>

                        <a type="button" class="btn btn-primary p-2 p-md- mb-4 "
                            style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" href="downloads_teacher.php">
                            <i class="bi bi-text-left"></i> สำหรับอาจารย์
                        </a>


                        <a type="button" class="btn btn-primary p-2 p-md- mb-4"
                            style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"  href="downloads_company.php">
            ...
            <div class="col-md-9">
                ...
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <h6 class="pb-1 border-bottom"><i class="bi bi-book"></i>  อาจารย์นิเทศ</h6>
