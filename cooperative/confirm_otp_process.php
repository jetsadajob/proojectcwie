...
$username = "itwebsit_itweb126_projectcwie";
$password = "Kt85gLyHOzgzEKosNw6s";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($user['role'] != null) {
            ...
            if ($user['role'] == "internship_student") {
                ...
                $insert_email_stmt = $conn->prepare("INSERT INTO coopperative_perental_consent_form (email) VALUES (?)");
                $insert_email_stmt->bind_param("s", $txt_email);
                $insert_email_stmt->execute();
