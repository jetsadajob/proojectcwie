                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-2">
                                        ...
                                        <select id="inputState" class="form-select" name="std_prefix" disabled>
                                ...
                                <div class="row mt-6">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputtext" placeholder="รหัสนักศึกษา" name="std_id" value="<?php echo isset($row['std_id']) ? $row['std_id'] : ''; ?>" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="inputState" class="form-select" name="major" disabled>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="studentIdInput" name="std_phone" class="form-control" placeholder="กรุณากรอกเบอร์โทร" value="<?php echo isset($row['std_phone']) ? $row['std_phone'] : ''; ?>" disabled>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="mb-2 text-muted" for="email">อีเมล</label>
                                        <input type="text" name="txt_email" class="form-control" placeholder="" value="<?php echo isset($row['email']) ? $row['email'] : ''; ?>" disabled>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="inputState" class="form-label">โครงการ</label>
                                        <select id="inputState" class="form-select" name="std_project" disabled>
                                    ...
                                    <div class="col-md-6">
                                        <label for="std_birthday" class="form-lable">วัน/เดือน/ปีเกิด</label>
                                        <input type="date" class="form-control" id="std_birthday" name="std_birthday" value="<?php echo isset($row['std_birthday']) ? $row['std_birthday'] : ''; ?>" disabled>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="inputtext" class="form-label">อายุ</label>
                                        <input type="text" class="form-control" id="inputtext" placeholder="กรุณากรอกวันเกิด" name="std_age" value="<?php echo isset($row['std_age']) ? $row['std_age'] : ''; ?> " disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-2">
                                        <label for="inputState" class="form-label">คำนำหน้า</label>
                                        <select id="inputState" class="form-select" name="teacher_prefix" disabled>
                                    ...
                                    <div class="col-md-5">
                                        <label for="inputtext" class="form-label">ชื่อ</label>
                                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="teacher_fname" value="<?php echo isset($row['teacher_fname']) ? $row['teacher_fname'] : ''; ?>" disabled>
                                    </div>

                                    <div class="col-md-5">
                                        <label for="inputtext" class="form-label">นามสกุล</label>
                                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="teacher_lname" value="<?php echo isset($row['teacher_lname']) ? $row['teacher_lname'] : ''; ?>" disabled>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputtext" class="form-label">อีเมล</label>
                                        <input type="text" class="form-control" id="inputtext" placeholder="กรอกอีเมล" name="teacher_email" value="<?php echo isset($row['teacher_email']) ? $row['teacher_email'] : ''; ?>" disabled>
                                    </div>
                                </div>

                                <a href="./cooperative_information.php">
                                    <div class="mt-5 text-center"><button class="btn btn-Warning profile-button" type="button">แก้ไขโปรไฟล์</button></div>
                                </a>
                            </div>
                        </div>
                    </div>
