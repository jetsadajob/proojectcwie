            ...
            <form class="row g-3" action="./cooperative_report_outline_insert.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col col-md-6">
                        <label for="inputtext" class="form-label">รหัสประจำตัวนักศึกษา</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="รหัสประจำตัวนักศึกษา" name="outline_std_id" value="<?php echo isset($std['std_id']) ? $std['std_id'] : ''; ?> " disabled>
                    </div>
                    <div class="col col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="รหัสไปรษณีย์" name="outline_zip" value="<?php echo isset($row['accommodation_zip']) ? $row['accommodation_zip'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <input type="tel" class="form-control" id="phone" placeholder="094xxxxxxx" name="outline_phone" value="<?php echo isset($row['accommodation_phone']) ? $row['accommodation_phone'] : ''; ?> " disabled>
                    </div>
                    <div class="col col-md-6">
                        <label for="inputtext" class="form-lable">เบอร์โทรสาร</label>
                        <input type="tel" class="form-control" id="phone" placeholder="043-xxx-xxx" name="outline_fax" value="<?php echo isset($row['accommodation_fax']) ? $row['accommodation_fax'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <input type="email" class="form-control" id="inputEmail4" name="email" value="<?php echo isset($row['accommodation_email']) ? $row['accommodation_email'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <p class="fw-bold"><br>ขอแจ้งรายละเอียดเกี่ยวกับโครงร่างรายงานการปฏิบัติงานสหกิจศึกษา ดังนี้</p>
                ...
                <div class="col-md-12">
                    <div class="uploaded-documents">
                        <p>- ไฟล์แผนปฏิบัติงานสหกิจศึกษา</p>
                    </div>
                </div>
                        ...
                        <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                            <?php if (!empty($row['outline_std_signature_img'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['outline_std_signature_img']); ?>" target="_blank">
                                    <img src="../uploads/<?php echo htmlspecialchars($row['outline_std_signature_img']); ?>" alt="รูปภาพ" style="width: 20%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                                </a>
                            <?php else : ?>
                        ...
                        <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                            <?php if (!empty($row['outline_staff_signature_img'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['outline_staff_signature_img']); ?>" target="_blank">
                                    <img src="../uploads/<?php echo htmlspecialchars($row['outline_staff_signature_img']); ?>" alt="รูปภาพ" style="width: 20%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                                </a>
                            <?php else : ?>
