...
if ($std = mysqli_fetch_assoc($result)) {
    ...
    $sql = "SELECT *
            ...
            WHERE coop_application_form.email = '$email'";
    $result = mysqli_query($conn, $sql);
        ...
        <div class="page-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">รายละเอียดใบสมัครงานสหกิจศึกษา</li>
                </ol>
            </nav>
            <div class="content container-fluid">
                        ...
                        <a href="./cooperative_application_edit.php"><button class="btn btn-warning" style="border-radius: 7px;"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <form class="row g-3" action="./cooperative_application_insert.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-mb-3">
                        ...
                        <div class="uploaded-documents text-center"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                            <?php if (!empty($row['std_application_profile_img'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['std_application_profile_img']); ?>" target="_blank">
                                    <img src="../uploads/<?php echo htmlspecialchars($row['std_application_profile_img']); ?>" alt="รูปภาพ" style="width: 10%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                                </a>
                            <?php else : ?>
                                <p>ไม่พบรูปภาพ</p>
                            <?php endif; ?>
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="coop_fname_thai" value="<?php echo isset($std['std_fname']) ? $std['std_fname'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-5">
                        <!-- 9	coop_lname_thai -->
                        <label for="inputtext" class="form-label">นามสกุล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="coop_lname_thai" value="<?php echo isset($std['std_lname']) ? $std['std_lname'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="studentIdInput" placeholder="6xxxxxxxx-x" name="coop_std_id" value="<?php echo isset($std['std_id']) ? $std['std_id'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select id="inputState" class="form-select" name="coop_advisor_prefix" disabled>
                            <option selected><?php echo isset($std['teacher_prefix']) ? $std['teacher_prefix'] : ''; ?></option>
                    ...
                    <div class="col-md-5">
                        <label for="inputtext" class="form-label">ชื่อ</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="coop_advisor_fname" value="<?php echo isset($std['teacher_fname']) ? $std['teacher_fname'] : ''; ?>" disabled>
                    </div>

                    <div class="col-md-5">
                        <label for="inputtext" class="form-label">นามสกุล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="coop_advisor_lname" value="<?php echo isset($std['teacher_lname']) ? $std['teacher_lname'] : ''; ?>" disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" class="form-control" id="coopPhoneInput" placeholder="กรอกหมายเลขโทรศัพท์" name="coop_phone" value="<?php echo isset($std['std_phone']) ? $std['std_phone'] : ''; ?> " disabled pattern="[0-9]{10}">
                    </div>
                    <div class="col-md-6">
                        <!-- 20	coop_email -->
                        <label for="inputEmail4" class="form-lable">Email</label>
                        <input type="email" class="form-control" id="inputEmail4" name="email" value="<?php echo isset($std['email']) ? $std['email'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" class="form-control" id="coopStdPhoneInput" placeholder="กรอกหมายเลขโทรศัพท์" name="coop_std_phone" value="<?php echo isset($std['std_phone']) ? $std['std_phone'] : ''; ?> " disabled pattern="[0-9]{10}">
                    </div>
                    <div class="col-md-6">
                        <!-- 27 coop_std_email -->
                        <label for="inputEmail4" class="form-lable">Email</label>
                    ...
                    <!-- <div class="col-md-6">
                        <div class="uploaded-documents">
                            <?php if (!empty($row['coop_applicant_signature'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_applicant_signature']); ?>" target="_blank">ดูชื่อผู้ลงสมัคร</a>
                            <?php else : ?>
                                <p>ไม่ชื่อผู้สมัคร</p>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                            <?php if (!empty($row['coop_applicant_signature'])) : ?>
                                <label for="formFile" class="form-label">ลงชื่อผู้สมัคร</label>
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_applicant_signature']); ?>" target="_blank">
                                    <img src="../uploads/<?php echo htmlspecialchars($row['coop_applicant_signature']); ?>" alt="รูปภาพ" style="width: 150px; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                                </a>
                            <?php else : ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="uploaded-documents">
                            <?php if (!empty($row['coop_petition_documennt'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_petition_documennt']); ?>" target="_blank">ดูใบคำร้องขอเข้าร่วมโครงการสหกิจศึกษา</a>
                            <?php else : ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="uploaded-documents">
                            <?php if (!empty($row['coop_copy_std_id_card_file'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_copy_std_id_card_file']); ?>" target="_blank">ดูสำเนาบัตรประจำตัวนักศึกษา</a>
                            <?php else : ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="uploaded-documents">
                            <?php if (!empty($row['coop_copy_id_card_file'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_copy_id_card_file']); ?>" target="_blank">ดูสำเนาบัตรประชาชน</a>
                            <?php else : ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="uploaded-documents">
                            <?php if (!empty($row['coop_copy_acadamic_report_file'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_copy_acadamic_report_file']); ?>" target="_blank">ดูสำเนาใบรายงานผลการศึกษา</a>
                            <?php else : ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="uploaded-documents">
                            <?php if (!empty($row['coop_cv_file'])) : ?>
                                ...
                                <a href="../uploads/<?php echo htmlspecialchars($row['coop_cv_file']); ?>" target="_blank">ดูประวัติส่วนตัว (CV)</a>
                            <?php else : ?>
