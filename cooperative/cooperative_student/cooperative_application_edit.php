        ...
        <div class="page-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../cooperative_student/cooperative_application_edit.php">รายละเอียดใบสมัครงานสหกิจศึกษา</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขใบสมัครงานสหกิจศึกษา</li>
                </ol>
            </nav>
            <div class="content container-fluid">
                ...
                <form class="row g-3" action="./cooperative_application_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="title" class="p-2 mb-2  text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image-fill" viewBox="0 0 16 16">
                        ...
                        <input class="form-control" type="file" id="formFile" name="std_application_profile_img">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="require" for="inputtext" class="form-label">ชื่อสถานประกอบการที่ต้องการสมัคร / Name of
                            employer</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อสถานประกอบการ" name="coop_name_of_employer" value="<?php echo isset($row['coop_name_of_employer']) ? $row['coop_name_of_employer'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 4	coop_position -->
                        <label class="require" for="inputtext" class="form-label">สมัครงานในตำแหน่ง / Position sought</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำแหน่ง" name="coop_position" value="<?php echo isset($row['coop_position']) ? $row['coop_position'] : ''; ?> " required>
                    </div>

                    <div class="col-md-6">
                        <label class="require" for="coop_working_period_start" class="form-lable">จาก / From</label>
                        <input type="date" class="form-control" id="coop_working_period_start" name="coop_working_period_start" value="<?php echo isset($row['coop_working_period_start']) ? $row['coop_working_period_start'] : ''; ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="require" for="coop_working_period_end" class="form-lable">ถึง / Until</label>
                        <input type="date" class="form-control" id="coop_working_period_end" name="coop_working_period_end" value="<?php echo isset($row['coop_working_period_end']) ? $row['coop_working_period_end'] : ''; ?>" required>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="" name="coop_fname_thai" oninput="validateThaiInput(this)" value="<?php echo isset($row['std_fname']) ? $row['std_fname'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-5">
                        <!-- 9	coop_lname_thai -->
                        <label class="require" for="inputtext" class="form-lable">นามสกุล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="" name="coop_lname_thai" oninput="validateThaiInput(this)" value="<?php echo isset($row['std_lname']) ? $row['std_lname'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-5">
                        <!-- 11	coop_fname_eng -->
                        <label class="require" for="inputtext" class="form-label">Name</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="Name" name="coop_fname_eng" oninput="validateEnglishInput(this)" value="<?php echo isset($row['coop_fname_eng']) ? $row['coop_fname_eng'] : ''; ?> " required>
                    </div>

                    <div class="col-md-5">
                        <!-- 12	coop_lname_eng -->
                        <label class="require" for="inputtext" class="form-label">Surname</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="Surname" name="coop_lname_eng" oninput="validateEnglishInput(this)" value="<?php echo isset($row['coop_lname_eng']) ? $row['coop_lname_eng'] : ''; ?> " required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="gpaInput" placeholder="เกรดเฉลี่ย" name="coop_gpa" value="<?php echo isset($row['coop_gpa']) ? $row['coop_gpa'] : ''; ?> " required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="coop_std_address" value="<?php echo isset($row['coop_std_address']) ? $row['coop_std_address'] : ''; ?> " required>
                    </div>

                    <div class="col-md-6">
                        <!-- 22	coop_std_subdistrict -->
                        <label class="require" for="inputtext" class="form-label">แขวง / ตำบล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="coop_std_subdistrict" value="<?php echo isset($row['coop_std_subdistrict']) ? $row['coop_std_subdistrict'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 23	coop_std_district -->
                        <label class="require" for="inputtext" class="form-label">เขต / อำเภอ</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="coop_std_district" value="<?php echo isset($row['coop_std_district']) ? $row['coop_std_district'] : ''; ?> " required>
                    </div>

                    <div class="col-md-6">
                        <!-- 24	coop_std_province -->
                        <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="coop_std_province" value="<?php echo isset($row['coop_std_province']) ? $row['coop_std_province'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 25	coop_std_zip -->
                        <label class="require" for="coopStdZip" class="form-label">รหัสไปรษณีย์</label>
                        <input type="text" class="form-control" id="coopStdZip" placeholder="รหัสไปรษณีย์" name="coop_std_zip" value="<?php echo isset($row['coop_std_zip']) ? $row['coop_std_zip'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 26 coop_std_phone -->
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="coop_emergency_fname" value="<?php echo isset($row['coop_emergency_fname']) ? $row['coop_emergency_fname'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 29	coop_emergency_lname -->
                        <label class="require" for="inputtext" class="form-label">นามสกุล / Surname</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="coop_emergency_lname" value="<?php echo isset($row['coop_emergency_lname']) ? $row['coop_emergency_lname'] : ''; ?> " required>
                    </div>

                    <div class="col-md-6">
                        <!-- 30	coop_emergency_relation -->
                        <label class="require" for="inputtext" class="form-label">ความเกี่ยวข้อง / Relation</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ความเกี่ยวข้อง" name="coop_emergency_relation" value="<?php echo isset($row['coop_emergency_relation']) ? $row['coop_emergency_relation'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 31	coop_emergency_occupation -->
                        <label for="inputtext" class="form-label">อาชีพ / Occupayion</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="อาชีพ" name="coop_emergency_occupation" value="<?php echo isset($row['coop_emergency_occupation']) ? $row['coop_emergency_occupation'] : ''; ?> ">
                    </div>

                    <div class="col-md-12">
                        <!-- 32	coop_emergency_place_of_work -->
                        <label for="inputtext" class="form-label">สถานที่ทำงาน / Place of Work</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อหน่วยงาน" name="coop_emergency_place_of_work" value="<?php echo isset($row['coop_emergency_place_of_work']) ? $row['coop_emergency_place_of_work'] : ''; ?> ">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <label class="require" for="inputAddress" class="form-label">บ้านเลขที่</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="coop_emergency_address" value="<?php echo isset($row['coop_emergency_address']) ? $row['coop_emergency_address'] : ''; ?> " required>
                    </div>

                    <div class="col-md-6">
                        <!-- 34	coop_emergency_subdistrict -->
                        <label class="require" for="inputtext" class="form-label">แขวง / ตำบล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="coop_emergency_subdistrict" value="<?php echo isset($row['coop_emergency_subdistrict']) ? $row['coop_emergency_subdistrict'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 35	coop_emergency_district -->
                        <label class="require" for="inputtext" class="form-label">เขต / อำเภอ</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="coop_emergency_district" value="<?php echo isset($row['coop_emergency_district']) ? $row['coop_emergency_district'] : ''; ?> " required>
                    </div>

                    <div class="col-md-6">
                        <!-- 	36	coop_emergency_province -->
                        <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="coop_emergency_province" value="<?php echo isset($row['coop_emergency_province']) ? $row['coop_emergency_province'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 37	coop_emergency_zip -->
                        <label class="require" for="coopEmergencyZip" class="form-label">รหัสไปรษณีย์</label>
                        <input type="text" class="form-control" id="coopEmergencyZip" placeholder="รหัสไปรษณีย์" name="coop_emergency_zip" value="<?php echo isset($row['coop_emergency_zip']) ? $row['coop_emergency_zip'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 	38	coop_emergency_phone -->
                        <label for="coopEmergencyPhoneInput" class="form-lable">โทรศัพท์</label>
                        <input type="tel" class="form-control" id="coopEmergencyPhoneInput" placeholder="กรอกหมายเลขโทรศัพท์" name="coop_emergency_phone" value="<?php echo isset($row['coop_emergency_phone']) ? $row['coop_emergency_phone'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <!-- 39	coop_emergency_email -->
                        <label for="inputEmail4" class="form-lable">Email</label>
                        <input type="email" class="form-control" id="inputEmail4" name="coop_emergency_email" value="<?php echo isset($row['coop_emergency_email']) ? $row['coop_emergency_email'] : ''; ?> ">
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="ลักษณะงานอาชีพที่นักศึกษาสนใจ" name="coop_career_objective" required><?php echo isset($row['coop_career_objective']) ? $row['coop_career_objective'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="file" id="formFile" name="coop_applicant_signature" >
                    </div>
                    ...
                    <div class="title" class="p-2 mb-2  text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
                        ...
                        <input class="form-control" type="file" id="formFile" name="coop_petition_documennt">
                    </div>
                    <div class="col-md-6">
                        <!-- 43	coop_copy_std_id_card_file -->
                        <label for="formFile" class="form-label">สำเนาบัตรประจำตัวนักศึกษา</label>
                        <input class="form-control" type="file" id="formFile" name="coop_copy_std_id_card_file">
                    </div>
                    <div class="col-md-6">
                        <!-- 44	coop_copy_id_card_file -->
                        <label for="formFile" class="form-label">สำเนาบัตรประชาชน</label>
                        <input class="form-control" type="file" id="formFile" name="coop_copy_id_card_file">
                    </div>
                    <div class="col-md-6">
                        <!-- 45	coop_copy_acadamic_report_file -->
                        <label for="formFile" class="form-label">สำเนาใบรายงานผลการศึกษา</label>
                        <input class="form-control" type="file" id="formFile" name="coop_copy_acadamic_report_file">
                    </div>
                    <div class="col-md-6">
                        <!-- 46	coop_cv_file -->
                        <label for="formFile" class="form-label">ประวัติส่วนตัว (CV)</label>
                        <input class="form-control" type="file" id="formFile" name="coop_cv_file">
                    </div>
