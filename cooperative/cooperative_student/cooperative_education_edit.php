        ...
        <div class="page-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../cooperative_student/education_detail.php">รายละเอียดแบบฟอร์มรายงานการปฏิบัติสหกิจศึกษา</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขแบบฟอร์มรายงานการปฏิบัติสหกิจศึกษา</li>
                </ol>
            </nav>
            <div class="content container-fluid">
                ...
                <form class="row g-3" action="./cooperative_education_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="studentIdInput" placeholder="6xxxxxxxx-x" name="std_id" value="<?php echo isset($std['std_id']) ? $std['std_id'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <!-- 7 -->
                        <label class="require" for="inputState" class="form-label">ชั้นปี</label>
                        <select id="inputState" class="form-select" name="year_of_study" disabled>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อหน่วยงาน" name="coop_report_company_name" value="<?php echo isset($row['accommodation_employer_thai']) ? $row['accommodation_employer_thai'] : ''; ?> " disabled>
                    </div>

                    <div class="col-12">
                        <!-- 9 -->
                        <label class="require" for="inputAddress" class="form-label">บ้านเลขที่</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="coop_report_address" value="<?php echo isset($row['accommodation_address']) ? $row['accommodation_address'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="require" for="inputtext" class="form-label">แขวง / ตำบล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="coop_report_subdistrict" value="<?php echo isset($row['accommodation_subdistrict']) ? $row['accommodation_subdistrict'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="require" for="inputtext" class="form-label">เขต / อำเภอ</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="coop_report_district" value="<?php echo isset($row['accommodation_district']) ? $row['accommodation_district'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="coop_report_protrict" value="<?php echo isset($row['accommodation_province']) ? $row['accommodation_province'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="require" for="coopreportzip" class="form-label">รหัสไปรษณีย์</label>
                        <input type="text" class="form-control" id="coopreportzip" placeholder="รหัสไปรษณีย์" name="coop_report_zip" pattern="[0-9]{5}" value="<?php echo isset($row['accommodation_zip']) ? $row['accommodation_zip'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <!-- 14 -->
                        <label class="require" for="inputtext" class="form-label">ชื่อพนักงานที่ปรึกษา</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อพนักงานที่ปรึกษา" name="coop_report_staff_name" value="<?php echo isset($row['accommodation_supervisor_fname']) ? $row['accommodation_supervisor_fname'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <!-- 15 -->
                        <label class="require" for="inputtext" class="form-label">ตำแหน่ง</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำแหน่ง" name="coop_report_position" value="<?php echo isset($row['accommodation_supervisor_position']) ? $row['accommodation_supervisor_position'] : ''; ?> " disabled>
                    </div>

                    <!-- 16 -->
                    <div class="col-md-6">
                        <label class="require" for="coop_report_date_start" class="form-lable">วันที่เริ่ม</label>
                        <input type="date" class="form-control" id="coop_report_date_start" name="coop_report_date_start" value="<?php echo isset($row['coop_report_date_start']) ? $row['coop_report_date_start'] : ''; ?>"required>
                    </div>
                    <!-- 17 -->
                    <div class="col-md-6">
                        <label class="require" for="coop_report_date_end" class="form-lable">วันที่สิ้นสุด</label>
                        <input type="date" class="form-control" id="coop_report_date_end" name="coop_report_date_end" value="<?php echo isset($row['coop_report_date_end']) ? $row['coop_report_date_end'] : ''; ?>"required>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ลักษณะงานของนักศึกษา" name="coop_report_job_description" required><?php echo isset($row['coop_report_job_description']) ? $row['coop_report_job_description'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="สิ่งที่ได้รับจากการปฏิบัติสหกิจศึกษา" name="coop_report_what_received" required><?php echo isset($row['coop_report_what_received']) ? $row['coop_report_what_received'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ความรู้ ความสามารถที่ได้เรียนมา ได้สนับสนุนกับงานที่ได้รับมอบหมายหรือไม่" name="coop_report_knowledge" required><?php echo isset($row['coop_report_knowledge']) ? $row['coop_report_knowledge'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="การมีส่วนร่วมกับองค์กร" name="coop_report_participation" required><?php echo isset($row['coop_report_participation']) ? $row['coop_report_participation'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ความพึงพอใจของนักศึกษา ต่อสวัสดิการที่ได้รับ เช่น สถานที่พัก" name="coop_report_satisfaction" required><?php echo isset($row['coop_report_satisfaction']) ? $row['coop_report_satisfaction'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="เหตุผล" name="coop_report_reson" required><?php echo isset($row['coop_report_reson']) ? $row['coop_report_reson'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อที่พัก" name="coop_report_accommodation_name" value="<?php echo isset($row['coop_report_accommodation_name']) ? $row['coop_report_accommodation_name'] : ''; ?> "required>
                    </div>
                    <div class="col-md-6">
                        <!-- 27 coop_report_expenses -->
                        <label class="require" for="inputtext" class="form-label">ค่าใช้จ่ายค่าที่พัก (บาท / เดือน)</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="xxxx" name="coop_report_expenses" value="<?php echo isset($row['coop_report_expenses']) ? $row['coop_report_expenses'] : ''; ?> "required>
                    </div>

                    <div class="col-12">
                        <!-- 28 coop_report_accommodation_address -->
                        <label class="require" for="inputAddress" class="form-label">ที่พักเลขที่</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="coop_report_accommodation_address" value="<?php echo isset($row['accommodation_accommodation_address']) ? $row['accommodation_accommodation_address'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <!-- 29 coop_report_accommodation_subdistrict -->
                        <label class="require" for="inputtext" class="form-label">แขวง / ตำบล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="coop_report_accommodation_subdistrict" value="<?php echo isset($row['accommodation_accommodation_subdistrict']) ? $row['accommodation_accommodation_subdistrict'] : ''; ?> " disabled>
                    </div>
                    <div class="col-md-6">
                        <!-- 30 coop_report_accommodation_district -->
                        <label class="require" for="inputtext" class="form-label">เขต / อำเภอ</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="coop_report_accommodation_district" value="<?php echo isset($row['accommodation_accommodation_district']) ? $row['accommodation_accommodation_district'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <!-- 31 coop_report_accommodation_province -->
                        <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="coop_report_accommodation_province" value="<?php echo isset($row['accommodation_accommodation_province']) ? $row['accommodation_accommodation_province'] : ''; ?> " disabled>
                    </div>
                    <div class="col-md-6">
                        <!-- 32 coop_report_accommodation_zip -->
                        <label class="require" for="coopreportaccommodationzip" class="form-label">รหัสไปรษณีย์</label>
                        <input type="text" class="form-control" id="coopreportaccommodationzip" placeholder="รหัสไปรษณีย์" name="coop_report_accommodation_zip" pattern="[0-9]{5}" value="<?php echo isset($row['accommodation_accommodation_zip']) ? $row['accommodation_accommodation_zip'] : ''; ?> " disabled>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="การเลือสถานประกอบการ" name="coop_report_choose" required><?php echo isset($row['coop_report_choose']) ? $row['coop_report_choose'] : ''; ?> </textarea>
                    </div>

                    <div class="col-md-12">
                        <!-- 35 coop_report_working -->
                        <label class="require" for="exampleFormControlTextarea1" class="form-label">การทำงาน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="การทำงาน" name="coop_report_working" required><?php echo isset($row['coop_report_working']) ? $row['coop_report_working'] : ''; ?> </textarea>
                    </div>

                    <div class="col-md-12">
                        <!-- 36 coop_report_colleage -->
                        <label class="require" for="exampleFormControlTextarea1" class="form-label">เพื่อนร่วมง่าน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="เพื่อนร่วมง่าน" name="coop_report_colleage" required><?php echo isset($row['coop_report_colleage']) ? $row['coop_report_colleage'] : ''; ?> </textarea>
                    </div>

                    <div class="col-md-12">
                        <!-- 37 coop_report_travel -->
                        <label class="require" for="exampleFormControlTextarea1" class="form-label">การเดินทางไปที่ทำงาน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="การเดินทางไปที่ทำงาน" name="coop_report_travel" required><?php echo isset($row['coop_report_travel']) ? $row['coop_report_travel'] : ''; ?> </textarea>
                    </div>

                    <div class="col-md-12">
                        <!-- 38 coop_report_safaty -->
                        <label class="require" for="exampleFormControlTextarea1" class="form-label">ที่พักและความปลอดภัย</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ที่พักและความปลอดภัย" name="coop_report_safaty" required><?php echo isset($row['coop_report_safaty']) ? $row['coop_report_safaty'] : ''; ?> </textarea>
                    </div>

                    <div class="col-md-12">
                        <!-- 39 coop_report_other -->
                        <label for="exampleFormControlTextarea1" class="form-label">อื่นๆ</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="อื่นๆ" name="coop_report_other"><?php echo isset($row['coop_report_other']) ? $row['coop_report_other'] : ''; ?> </textarea>
                    </div>

                    <div class="col-md-12">
                        <!-- 40 coop_report_other_suggestions -->
                        <label for="exampleFormControlTextarea1" class="form-label">ข้อเสนอแนะอื่นๆ</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ข้อเสนอแนะอื่นๆ" name="coop_report_other_suggestions" ><?php echo isset($row['coop_report_other_suggestions']) ? $row['coop_report_other_suggestions'] : ''; ?> </textarea>
                    </div>
