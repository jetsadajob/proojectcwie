            ...
            <form class="row g-3" action="./coopperative_education_insert.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col col-md-5">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="coop_report_fname" value="<?php echo isset($std['std_fname']) ? $std['std_fname'] : ''; ?> " disabled>
                    </div>

                    <div class="col col-md-5">
                        <!-- 5 -->
                        <label for="inputtext" class="form-label">นามสกุล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="coop_report_lname" value="<?php echo isset($std['std_lname']) ? $std['std_lname'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="6xxxxxxxx-x" name="std_id" value="<?php echo isset($std['std_id']) ? $std['std_id'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col col-md-6">
                        ...
                        <select id="inputState" class="form-select" name="coop_report_year_of_study" disabled>
                            <option><?php echo isset($std['year_of_study']) ? $std['year_of_study'] : ''; ?></option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-6">
                        <!-- 8 -->
                        <label for="inputtext" class="form-label">ชื่อสถานประกอบการ</label>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="รหัสไปรษณีย์" name="coop_report_zip" value="<?php echo isset($row['accommodation_zip']) ? $row['accommodation_zip'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        <!-- 14 -->
                        <label for="inputtext" class="form-label">ชื่อพนักงานที่ปรึกษา</label>
                ...
                <div class="row">
                    <div>
                        <br>
                        <p class="fw-semibold">การประเมินสถานประกอบการ</p>
                ...
                <div class="row">
                    <div>
                        <p class="fw-semibold">นักศึกษาพักที่</p>
                ...
                <div class="row">
                    <div>
                        <p class=" fw-semibold">การประเมินที่พัก</p>
                ...
                <div class="title" class="p-2 mb-2  text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentcol Color" class="bi bi-chat-left-text-fill" viewBox="0 0 16 16">
                ...
                <div class="row">
                    <div class="col col-md-12">
                        <!-- 36 coop_report_col colleage -->
                        <label for="exampleFormControlTextarea1" class="form-label">เพื่อนร่วมง่าน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="เพื่อนร่วมง่าน" name="coop_report_col colleage" disabled><?php echo isset($row['coop_report_col colleage']) ? $row['coop_report_col colleage'] : ''; ?> </textarea>
                    </div>
                </div>
