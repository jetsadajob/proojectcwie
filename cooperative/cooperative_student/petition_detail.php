    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="text-right">
                <a href="./cooperative_petition_edit.php"><button class="btn btn-warning" style="border-radius: 7px;"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
            ...
            <form class="row g-3" action="./cooperative_petition_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="petition_address" value="<?php echo isset($row1['petition_address']) ? $row1['petition_address'] : ''; ?>" disabled>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control" id="inputEmail4" name="petition_email" placeholder="กรอกอีเมล" value="<?php echo isset($row1['petition_email']) ? $row1['petition_email'] : ''; ?> " disabled>
                </div>
                ...
                <div class="col-md-6">
                    <div class="uploaded-documents">
                        <?php if (!empty($row1['petition_graduation_document_file'])) : ?>
                            <label for="formFile" class="form-label">เอกสารตรวจสอบการสำเร็จการศึกษา</label>
                            <a href="../uploads/<?php echo htmlspecialchars($row1['petition_graduation_document_file']); ?>" target="_blank">ดูเอกสาร</a>
                        <?php else : ?>
                ...
                <div class="col-md-6">
                    <div class="uploaded-documents">
                        <?php if (!empty($row1['petition_book'])) : ?>
                            <label for="formFile" class="form-label">หนังสือยินยอมของผู้ปกครอง</label>
                            <a href="../uploads/<?php echo htmlspecialchars($row1['petition_book']); ?>" target="_blank">ดูเอกสาร</a>
                        <?php else : ?>
                ...
                <div class="col-md-6">
                    <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                        <?php if (!empty($row1['petition_applicant_signature_file'])) : ?>
                            ...
                            <a href="../uploads/<?php echo htmlspecialchars($row1['petition_applicant_signature_file']); ?>" target="_blank">
                                <img src="../uploads/<?php echo htmlspecialchars($row1['petition_applicant_signature_file']); ?>" alt="รูปภาพ" style="width: 20%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                            </a>
                        <?php else : ?>
                ...
                <!-- <div class="uploaded-documents">
                    <?php if (!empty($row1['petition_applicant_signature_file'])) : ?>
                        <label for="formFile" class="form-label">ลายเซ็นผู้ยื่นคำร้อง</label>
                        <a href="../uploads/<?php echo htmlspecialchars($row1['petition_applicant_signature_file']); ?>" target="_blank">ดูเอกสาร</a>
                    <?php else : ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="male" name="petition_date" value="<?php echo isset($row1['petition_date']) ? $row1['petition_date'] : ''; ?>" disabled>
                </div>
                    ...
                    <ol>
                        <li>ผ่านรายวิชา 300202/SC002001 การเตรียมความพร้อมสหกิจศึกษา ในภาคการศึกษา
                            ...
                            <select class="option" id="exampleFormControlSelect1" name="petition_semestor" disabled>
                                <option selected>
                                    <?php echo isset($row1['petition_semestor']) ? $row1['petition_semestor'] : ''; ?>
                                </option>
                            ...
                            <select class="option" id="exampleFormControlSelect1" name="petition_academic_year" disabled>
                                <option selected>
                                    <?php echo isset($row1['petition_academic_year']) ? $row1['petition_academic_year'] : ''; ?>
                                </option>
                ...
                <div class="col-md-6">
                    <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                        <?php if (!empty($row1['petition_signatore_leture_img'])) : ?>
                            ...
                            <a href="../uploads/<?php echo htmlspecialchars($row1['petition_signatore_leture_img']); ?>" target="_blank">
                                <img src="../uploads/<?php echo htmlspecialchars($row1['petition_signatore_leture_img']); ?>" alt="รูปภาพ" style="width: 20%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                            </a>
                        <?php else : ?>
