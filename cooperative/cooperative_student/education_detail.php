        ...
        <div class="page-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">รายละเอียดวันที่แบบฟอร์มรายงานการปฏิบัติสหกิจศึกษา</li>
                </ol>
            </nav>
            <div class="content container-fluid">
                        ...
                        <a href="./cooperative_education_edit.php"><button class="btn btn-warning" style="border-radius: 7px;"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
