        ...
        <div class="page-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../cooperative_student/report_outline_detail.php">รายละเอียดแบบแผนและโครงร่างรายงานการปฏิบัติงานสหกิจศึกษา</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขแบบแผนและโครงร่างรายงานการปฏิบัติงานสหกิจศึกษา</li>
                </ol>
            </nav>
            <!-- ส่วนของข้อมูล -->
            <div class="content container-fluid">
                ...
                <form class="row g-3" action="./cooperative_report_outline_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" class="form-control" id="phoneInput" placeholder="กรอกหมายเลขโทรศัพท์" name="outline_phone" value="<?php echo isset($row['outline_phone']) ? $row['outline_phone'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <label for="inputtext" class="form-lable">เบอร์โทรสาร</label>
                        <input type="tel" class="form-control" id="phone" placeholder="กรอกเบอร์โทรสาร" name="outline_fax" value="<?php echo isset($row['outline_fax']) ? $row['outline_fax'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <label class="require" for="inputEmail4" class="form-lable">Email</label>
                        <input type="email" class="form-control" id="inputEmail4" name="outline_email" value="<?php echo isset($row['outline_email']) ? $row['outline_email'] : ''; ?> " required>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="" name="outline_detail_title_thai" oninput="validateThaiInput(this)" value="<?php echo isset($row['outline_detail_title_thai']) ? $row['outline_detail_title_thai'] : ''; ?> " required>
                    </div>
                    <div class="col-md-6">
                        <label class="require" for="inputtext" class="form-lable">ภาษาอังกฤษ</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="" name="outline_detail_title_eng" oninput="validateEnglishInput(this)" value="<?php echo isset($row['outline_detail_title_eng']) ? $row['outline_detail_title_eng'] : ''; ?> " required>
                    </div>

                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea1" class="form-label">2.
                            วัตถุประสงค์</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="วัตถุประสงค์" name="outline_detail_description" required><?php echo isset($row['outline_detail_description']) ? $row['outline_detail_description'] : ''; ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea2" class="form-label">3.
                            ผลที่คาดว่าจะได้รับ</label>
                        <textarea class="form-control" id="exampleFormControlTextarea2" rows="4" placeholder="ผลที่คาดว่าจะได้รับ" name="outline_detail_expected_results" required><?php echo isset($row['outline_detail_expected_results']) ? $row['outline_detail_expected_results'] : ''; ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea3" class="form-label">4. ความสำคัญ
                            และที่มา</label>
                        <textarea class="form-control" id="exampleFormControlTextarea3" rows="4" placeholder="ความสำคัญ และที่มา" name="outline_detail_significance" required><?php echo isset($row['outline_detail_significance']) ? $row['outline_detail_significance'] : ''; ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea4" class="form-label">5.
                            เอกสารอ้างอิง:</label>
                        <textarea class="form-control" id="exampleFormControlTextarea4" rows="4" placeholder="เอกสารอ้างอิง:" name="outline_detail_reference" required><?php echo isset($row['outline_detail_reference']) ? $row['outline_detail_reference'] : ''; ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea5" class="form-label">6.
                            ระเบียบวิธีดำเนินโครงงาน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea5" rows="4" placeholder="ระเบียบวิธีดำเนินโครงงาน" name="outline_detail_pjmethodology" required><?php echo isset($row['outline_detail_pjmethodology']) ? $row['outline_detail_pjmethodology'] : ''; ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea6" class="form-label">7.
                            ขอบเขตของโครงงาน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea6" rows="4" placeholder="ขอบเขตของโครงงาน" name="outline_detail_scope" required><?php echo isset($row['outline_detail_scope']) ? $row['outline_detail_scope'] : ''; ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label for="exampleFormControlTextarea7" class="form-label">8.
                            ข้อเสนอแนะอื่นๆ</label>
                        <textarea class="form-control" id="exampleFormControlTextarea7" rows="4" placeholder="ข้อเสนอแนะอื่นๆ" name="outline_detail_other"><?php echo isset($row['outline_detail_other']) ? $row['outline_detail_other'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="file" id="formFile" name="outline_staff_signature_img">
                    </div>
