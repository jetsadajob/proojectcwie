...
if ($std = mysqli_fetch_assoc($result)) {
    ...
    JOIN petition_document ON cooperative_report_outline.email = petition_document.email
...
<body>
                ...
                <div class="page-wrapper">
                        <nav aria-label="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../cooperative_student/cooperative_student_home.php">แบบฟอร์มสหกิจศึกษา</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">แบบแผนและโครงร่างรายงานการปฏิบัติงานสหกิจศึกษา</li>
                                </ol>
                        </nav>
                        <div class="content container-fluid">
                                ...
                                <form class="row g-3" action="./cooperative_report_outline_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-2">
                                                ...
                                                <select id="inputState" class="form-select" name="outline_prefix" >
                                        ...
                                        <div class="col-md-5">
                                                ...
                                                <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="outline_fname" value="<?php echo isset($std['std_fname']) ? $std['std_fname'] : ''; ?> " >
                                        </div>
                                        <div class="col-md-5">
                                                <label class="require" for="inputtext" class="form-label">นามสกุล
                                                </label>
                                                <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="outline_lname" value="<?php echo isset($std['std_lname']) ? $std['std_lname'] : ''; ?> " >
                                        </div>
                                        <div class="col-md-6">
                                                <label class="require" for="studentIdInput" class="form-label">รหัสนักศึกษา</label>
                                                <input type="text" class="form-control" id="studentIdInput" placeholder="6xxxxxxxx-x" name="outline_std_id" value="<?php echo isset($std['std_id']) ? $std['std_id'] : ''; ?> " >
                                        </div>
                                        <div class="col-md-6">
                                                <label class="require" for="inputState" class="form-label">สาขาวิชา</label>
                                                <select id="inputState" class="form-select" name="outline_field_of_study" >
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <select id="inputState" class="form-select" name="outline_faculty" >
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="inputAddress" placeholder="บริษัท ปตท. จำกัด(มหาชน)" name="outline_company_name" value="<?php echo isset($row['petition_organiztion_name']) ? $row['petition_organiztion_name'] : ''; ?> " >
                                        </div>
                                        <div class="col-md-6">
                                                <label class="require" for="inputAddress" class="form-label">ที่อยู่</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="outline_address" value="<?php echo isset($row['petition_address']) ? $row['petition_address'] : ''; ?> " >
                                        </div>

                                        <div class="col-md-6">
                                                <label class="require" for="inputtext" class="form-label">ตำบล / แขวง</label>
                                                <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="outline_subdistrict" value="<?php echo isset($row['petition_subdistrict']) ? $row['petition_subdistrict'] : ''; ?> " >
                                        </div>
                                        <div class="col-md-6">
                                                <label class="require" for="inputtext" class="form-label">อำเภอ / เขต </label>
                                                <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="outline_district" value="<?php echo isset($row['petition_district']) ? $row['petition_district'] : ''; ?> " >
                                        </div>

                                        <div class="col-md-6">
                                                <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                                                <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="outline_province" value="<?php echo isset($row['petition_province']) ? $row['petition_province'] : ''; ?> " >
                                        </div>
                                        <div class="col-md-6">
                                                <label class="require" for="inputZip" class="form-label">รหัสไปรษณีย์</label>
                                                <input type="text" class="form-control" id="inputZip" placeholder="รหัสไปรษณีย์" name="outline_zip" pattern="[0-9]{5}" value="<?php echo isset($row['petition_zip']) ? $row['petition_zip'] : ''; ?> " >
                                        </div>

                                        <div class="col-md-6">
                                                <label for="phoneInput" class="form-label">เบอร์โทรติดต่อ</label>
                                                <input type="tel" class="form-control" id="phoneInput" placeholder="กรอกหมายเลขโทรศัพท์" name="outline_phone"  pattern="[0-9]{10}" value="<?php echo isset($row['petition_phone']) ? $row['petition_phone'] : ''; ?>" >
                                        </div>
                                        <div class="col-md-6">
                                                <label for="inputtext" class="form-lable">เบอร์โทรสาร</label>
                                                <input type="tel" class="form-control" id="phone" placeholder="กรอกเบอร์โทรสาร" name="outline_fax" value="<?php echo isset($row['petition_fax']) ? $row['petition_fax'] : ''; ?>" >
                                        </div>
                                        <div class="col-md-6">
                                                <label class="require" for="inputEmail4" class="form-lable">Email</label>
                                                <input type="email" class="form-control" id="inputEmail4" name="outline_email" placeholder="กรอกอีเมล" value="<?php echo isset($row['petition_email']) ? $row['petition_email'] : ''; ?> " >
                                        </div>
                                        <hr>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="inputtext" placeholder="" name="outline_detail_title_thai" oninput="validateThaiInput(this)" required>
                                        </div>

                                        <div class="col-md-6">
                                                <label class="require" for="inputtext" class="form-lable">ภาษาอังกฤษ</label>
                                                <input type="text" class="form-control" id="inputtext" placeholder="" name="outline_detail_title_eng" oninput="validateEnglishInput(this)" required>
                                        </div>

                                        <div class="col-md-12">
                                                <label class="require" for="exampleFormControlTextarea1" class="form-label">2.
                                                        วัตถุประสงค์</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="วัตถุประสงค์" name="outline_detail_description" required></textarea>
                                        </div>
                                        <div class="col-md-12">
                                                <label class="require" for="exampleFormControlTextarea2" class="form-label">3.
                                                        ผลที่คาดว่าจะได้รับ</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea2" rows="4" placeholder="ผลที่คาดว่าจะได้รับ" name="outline_detail_expected_results" required></textarea>
                                        </div>
                                        <div class="col-md-12">
                                                <label class="require" for="exampleFormControlTextarea3" class="form-label">4. ความสำคัญ
                                                        และที่มา</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea3" rows="4" placeholder="ความสำคัญ และที่มา" name="outline_detail_significance" required></textarea>
                                        </div>
                                        <div class="col-md-12">
                                                <label class="require" for="exampleFormControlTextarea4" class="form-label">5.
                                                        เอกสารอ้างอิง:</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea4" rows="4" placeholder="เอกสารอ้างอิง:" name="outline_detail_reference" required></textarea>
                                        </div>
                                        <div class="col-md-12">
                                                <label class="require" for="exampleFormControlTextarea5" class="form-label">6.
                                                        ระเบียบวิธีดำเนินโครงงาน</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea5" rows="4" placeholder="ระเบียบวิธีดำเนินโครงงาน" name="outline_detail_pjmethodology" required></textarea>
                                        </div>
                                        <div class="col-md-12">
                                                <label class="require" for="exampleFormControlTextarea6" class="form-label">7.
                                                        ขอบเขตของโครงงาน</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea6" rows="4" placeholder="ขอบเขตของโครงงาน" name="outline_detail_scope" required></textarea>
                                        </div>
                                        <div class="col-md-12">
                                                <label for="exampleFormControlTextarea7" class="form-label">8.
                                                        ข้อเสนอแนะอื่นๆ</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea7" rows="4" placeholder="ข้อเสนอแนะอื่นๆ" name="outline_detail_other"></textarea>
                                        </div>
                        ...
                        <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM8.5 7v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 1 0z" />
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <input class="form-control" type="file" id="formFile" name="outline_work_plan_file">
                                        </div><br>
                       
                                        <div class="col-md-6">
                                                <label class="require" for="formFile" class="form-label">ลายเซ็นนักศึกษา</label>
                                                <input class="form-control" type="file" id="formFile" name="outline_std_signature_img">
                                        </div>
                                        <!-- <div class="col-md-6">
                                                <label  for="formFile" class="form-label">ลายเซ็นพนักงานที่ปรึกษา</label>
                                                <input class="form-control" type="file" id="formFile" name="outline_staff_signature_ime">
                                        </div> -->
        ...
        <!-- เช็คแบบฟอร์มที่กรอกได้แค่ภาษาไทย -->
        <script>
        ...
        <!-- เช็คแบบฟอร์มที่กรอกได้แค่ภาษาอังกฤษ -->
        <script>
