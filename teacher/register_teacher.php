...
<body>
    ...
    <form action="register_db_teacher.php" method="post" class="form-horizontal my-5">
        <section class="h-100">
                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                        <div class="card shadow-lg">
                            <div class="card-body p-5">
                                ...
                                <h1 class="fs-4 card-title fw-bold mb-4 mt-4 text-center">ลงทะเบียนสำหรับอาจารย์</h1>
                                <form method="POST" class="needs-validation" novalidate="" autocomplete="off">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="txt_role" class="form-select">
                                            ...
                                            <option value="supervision_teacher">อาจารย์นิเทศ</option>
                                            <option value="advisor">อาจารย์ที่ปรึกษา</option>
                                            <option value="course_instructor">อาจารย์ประจำรายวิชา</option>

                                        </select>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="mb-2 text-muted" for="prefix">คำนำหน้า</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="mb-2 text-muted" for="name">ชื่อ</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="text-center mt-2">
                                        มีบัญชีอยู่แล้ว? <a href="login_teacher.php">เข้าสู่ระบบ</a>
                                    </div>
                            </div>
                        </div>
                    </div>
