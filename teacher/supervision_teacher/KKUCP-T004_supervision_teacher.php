            ...
            <div class="content container-fluid">
                ...
                <form class="row g-3" action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อสถานประกอบการ" name=""
                            required>
                    </div>

                    <div class="col-md-6">
                        <label class="require" for="inputtext" class="form-label">สถานที่ตั้ง (อำเภอ/เขต)</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="สถานที่ตั้ง" name=""
                            required>
                    </div>
                    <div class="col-md-6">
                        <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="" required>
                    </div>
                    <div class="col-md-6">
                        <label class="require" for="male" class="form-lable">วันที่นิเทศงานนักศึกษา</label>
                        <input type="date" class="form-control" id="male" name="" required>
                    </div>

                    <div>รายชื่อนักศึกษาที่ได้รับการนิเทศในสถานประกอบการแห่งนี้ จำนวน
                        <select class="option" id="exampleFormControlSelect1" name="" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="" name=""
                            required></textarea>
                    </div>
                    <hr>
                    <div class="col-md-6">
                        <label class="require" for="formFile" class="form-label">ลงชื่ออาจารย์นิเทศ</label>
                        <input class="form-control" type="file" id="formFile" name="" required>
                    </div>
                    <div class="col-md-12">
                        <label class="require" for="exampleFormControlTextarea1"
                            class="form-label">รายนามคณาจารย์ผู้ร่วมนิเทศงาน</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4"
                            placeholder="รายนามคณาจารย์ผู้ร่วมนิเทศงาน" name="" required></textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อนักศึกษา" name=""
                            required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="inputState" class="form-select" name="" required>
                            <option selected>-- เลือก --</option>
                        ...
                        <table class="table table-bordered table-condensed">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic1" value="5"
                                            id="topic1" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic1" value="4"
                                            id="topic1" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic1" value="3"
                                            id="topic1" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic1" value="2"
                                            id="topic1" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic1" value="1"
                                            id="topic1" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">2</td>
                                    <td>ได้เรียนรู้จากงานที่ได้รับมอบหมาย</td>
                                    <td style="text-align:center;"><input type="radio" name="topic2" value="5"
                                            id="topic2" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic2" value="4"
                                            id="topic2" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic2" value="3"
                                            id="topic2" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic2" value="2"
                                            id="topic2" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic2" value="1"
                                            id="topic2" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">3</td>
                                    <td>ลักษณะงานที่ได้รับมอบหมาย</td>
                                    <td style="text-align:center;"><input type="radio" name="topic3" value="5"
                                            id="topic3" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic3" value="4"
                                            id="topic3" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic3" value="3"
                                            id="topic3" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic3" value="2"
                                            id="topic3" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic3" value="1"
                                            id="topic3" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">4</td>
                                    <td>ความรู้ ความสามารถที่ได้เรียนมา ได้สนับสนุนกับงานที่รับมอบหมายหรือไม่?</td>
                                    <td style="text-align:center;"><input type="radio" name="topic4" value="5"
                                            id="topic4" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic4" value="4"
                                            id="topic4" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic4" value="3"
                                            id="topic4" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic4" value="2"
                                            id="topic4" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic4" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic5" value="5"
                                            id="topic5" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic5" value="4"
                                            id="topic5" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic5" value="3"
                                            id="topic5" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic5" value="2"
                                            id="topic5" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic5" value="1"
                                            id="topic5" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">6</td>
                                    <td>ความพึงพอใจของนักศึกษาต่อองค์กร</td>
                                    <td style="text-align:center;"><input type="radio" name="topic6" value="5"
                                            id="topic6" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic6" value="4"
                                            id="topic6" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic6" value="3"
                                            id="topic6" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic6" value="2"
                                            id="topic6" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic6" value="1"
                                            id="topic6" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">7</td>
                                    <td>ความพึงพอใจของนักศึกษา ต่อสวัสดิการที่ได้รับ เช่น สถานที่พัก
                                    </td>
                                    <td style="text-align:center;"><input type="radio" name="topic7" value="5"
                                            id="topic7" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic7" value="4"
                                            id="topic7" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic7" value="3"
                                            id="topic7" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic7" value="2"
                                            id="topic7" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic7" value="1"
                        ...
                        <table class="table table-bordered table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>ผู้บริหาร</td>
                                    <td style="text-align:center;"><input type="radio" name="topic47" value="5"
                                            id="topic47" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic47" value="4"
                                            id="topic47" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic47" value="3"
                                            id="topic47" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic47" value="2"
                                            id="topic47" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic47" value="1"
                                            id="topic47" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">1.2</td>
                                    <td>เจ้าหน้าที่ฝ่ายบุคคล</td>
                                    <td style="text-align:center;"><input type="radio" name="topic48" value="5"
                                            id="topic48" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic48" value="4"
                                            id="topic48" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic48" value="3"
                                            id="topic48" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic48" value="2"
                                            id="topic48" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic48" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic49" value="5"
                                            id="topic49" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic49" value="4"
                                            id="topic49" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic49" value="3"
                                            id="topic49" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic49" value="2"
                                            id="topic49" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic49" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic50" value="5"
                                            id="topic50" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic50" value="4"
                                            id="topic50" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic50" value="3"
                                            id="topic50" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic50" value="2"
                                            id="topic50" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic50" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic51" value="5"
                                            id="topic51" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic51" value="4"
                                            id="topic51" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic51" value="3"
                                            id="topic51" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic51" value="2"
                                            id="topic51" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic51" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic52" value="5"
                                            id="topic52" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic52" value="4"
                                            id="topic52" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic52" value="3"
                                            id="topic52" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic52" value="2"
                                            id="topic52" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic52" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic53" value="5"
                                            id="topic53" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic53" value="4"
                                            id="topic53" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic53" value="3"
                                            id="topic53" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic53" value="2"
                                            id="topic53" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic53" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic54" value="5"
                                            id="topic54" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic54" value="4"
                                            id="topic54" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic54" value="3"
                                            id="topic54" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic54" value="2"
                                            id="topic54" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic54" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic55" value="5"
                                            id="topic55" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic55" value="4"
                                            id="topic55" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic55" value="3"
                                            id="topic55" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic55" value="2"
                                            id="topic55" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic55" value="1"
                                            id="topic55" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">3.4</td>
                                    <td>พนักงานที่ปรึกษามีความรู้ และประสบการณ์ ตรงกับสาขาวิชาชีพของนักศึกษา
                                    </td>
                                    <td style="text-align:center;"><input type="radio" name="topic56" value="5"
                                            id="topic56" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic56" value="4"
                                            id="topic56" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic56" value="3"
                                            id="topic56" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic56" value="2"
                                            id="topic56" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic56" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic57" value="5"
                                            id="topic57" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic57" value="4"
                                            id="topic57" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic57" value="3"
                                            id="topic57" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic57" value="2"
                                            id="topic57" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic57" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic58" value="5"
                                            id="topic58" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic58" value="4"
                                            id="topic58" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic58" value="3"
                                            id="topic58" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic58" value="2"
                                            id="topic58" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic58" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic59" value="5"
                                            id="topic59" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic59" value="4"
                                            id="topic59" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic59" value="3"
                                            id="topic59" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic59" value="2"
                                            id="topic59" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic59" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic60" value="5"
                                            id="topic60" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic60" value="4"
                                            id="topic60" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic60" value="3"
                                            id="topic60" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic60" value="2"
                                            id="topic60" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic60" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic61" value="5"
                                            id="topic61" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic61" value="4"
                                            id="topic61" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic61" value="3"
                                            id="topic61" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic61" value="2"
                                            id="topic61" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic61" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic62" value="5"
                                            id="topic62" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic62" value="4"
                                            id="topic62" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic62" value="3"
                                            id="topic62" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic62" value="2"
                                            id="topic62" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic62" value="1"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><input type="radio" name="topic63" value="5"
                                            id="topic63" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic63" value="4"
                                            id="topic63" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic63" value="3"
                                            id="topic63" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic63" value="2"
                                            id="topic63" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic63" value="1"
                                            id="topic63" title="1 น้อยที่สุด"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">4.</td>
                                    <td>คุณภาพโดยรวมของสถานประกอบการแห่งนี้</td>
                                    <td style="text-align:center;"><input type="radio" name="topic64" value="5"
                                            id="topic64" title="5 มากที่สุด"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic64" value="4"
                                            id="topic64" title="4 มาก"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic64" value="3"
                                            id="topic64" title="3 ปานกลาง"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic64" value="2"
                                            id="topic64" title="2 น้อย"></td>
                                    <td style="text-align:center;"><input type="radio" name="topic64" value="1"
