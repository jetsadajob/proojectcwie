                        ...
                        <div class="col-md-12">
                            <div class="nameform">
                                <div class="page-header">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h5 class="text-center">ข้อมูลนักศึกษา</h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped table-responsive table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>นางสาวลลิษา มโนบาล</td>
                                                <td>
                                                    <li>
                                                        <span class="text-danger">ยังไม่ทำแบบประเมิน</span>
                                                    </li>
                                                </td>
                                                <td>
                                                    <a href="./student_detail.php"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./internship_detail.php"><button type="button"
                                                            class="btn btn-outline-primary"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor" class="bi bi-eye-fill"
                                                                viewBox="0 0 16 16">
                                            ...
                                            <tr>
                                                ...
                                                <td>นางสาวสุธินันท์ พรหมศิริ</td>
                                                <td>
                                                    <li>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#">
                                                        <button type="button" class="btn btn-outline-danger"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor" class="bi bi-trash-fill"
                                                                viewBox="0 0 16 16">
                                                                <path
