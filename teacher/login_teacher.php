...
<body>
    ...
    <form action="login_db_teacher.php" method="post" class="form-horizontal my-5">
        <section class="h-100">
                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                        <div class="card shadow-lg">
                            <div class="card-body p-5">
                                ...
                                <h1 class="fs-4 card-title fw-bold mb-4 mt-4 text-center">เข้าสู่ระบบสำหรับอาจารย์</h1>
                                <form method="POST" class="needs-validation" novalidate="" autocomplete="off">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="mb-2 w-100">
                                            ...
                                            <a href="forgot_teacher.php" class="float-end">
                                                ลืมรหัสผ่าน?
                                            </a>
                                        </div>
                                    </div> <br>
                                    ...
                                    <div class="text-center mt-2">
                                        มีบัญชีหรือยัง? <a href="register_teacher.php">ลงทะเบียน</a>
                                    </div>
                            </div>
                        </div>
                    </div>
