        ...
        <div class="content container-fluid">
                            ...
                            <div class="file-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img alt="" src="../assets/img/icon.png"></a>
                                    </div>
                                </div>
            ...
            <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                  ...
                                                  AND login_student.email = '$id'";
                                                    ...
                                                    $sql_job_description = "SELECT * FROM job_description_accommodation WHERE email ='$id' ";
                                                    $result_job_description = mysqli_query($conn, $sql_job_description);
                                                    $row_job_description = mysqli_fetch_array($result_job_description);


                                                    // เรียกข้อมูลจากตาราง cooperative_report_outline
                                                    $sql_report_outline = "SELECT * FROM cooperative_report_outline WHERE email ='$id' ";
                                                    $result_report_outline = mysqli_query($conn, $sql_report_outline);
                                                    $row_report_outline = mysqli_fetch_array($result_report_outline);
                                                    ...
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php elseif ($row_petition["status_admin"] == 1) : ?>
                                                                        <span class="badge badge-pill badge-warning">รอตรวจสอบ</span><span class="badge badge-pill badge-warning">รอตรวจสอบ</span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="./student_acceptance_form.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                                                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                                                            </svg></button></a>
                                                                    </svg></button></a>
                                                            ...
                                                            <!-- <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span
                                                                        class="badge badge-pill badge-danger">ยังไม่กรอกฟอร์ม</span>
                                                                    <?php elseif ($row_education["status_admin"] == 1) : ?>
                                                                    <span
                                                                        class="badge badge-pill badge-warning">รอตรวจสอบ</span>
                                                                    <?php elseif ($row_education["status_admin"] == 2) : ?>
                                                                    <span
                                                                        class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                                    <?php elseif ($row_education["status_admin"] == 3) : ?>
                                                                    <span
                                                                        class="badge badge-warning">มีข้อมูลต้องแก้ไข</span>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="./education_detail.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                                                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                                                            </svg></button></a>
                                                                    </svg></button></a>
                ...
                <div class="tab-pane fade" id="advisor">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">เอกสารที่ส่งให้อาจารย์ที่ปรึกษา</h3>
                            <form>
                                <div class="page-header">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($row_job_description["status_admin"] == 0) : ?>
                                                                <span class="badge badge-pill badge-danger">ยังไม่กรอกฟอร์ม</span>
                                                            <?php elseif ($row_job_description["status_admin"] == 1) : ?>
                                                                <span class="badge badge-pill badge-warning">รอตรวจสอบ</span>
                                                            <?php elseif ($row_job_description["status_admin"] == 2) : ?>
                                                                <span class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                            <?php elseif ($row_job_description["status_admin"] == 3) : ?>
                                                                <span class="badge badge-warning">มีข้อมูลต้องแก้ไข</span>
                                                            <?php elseif ($row_job_description["status_admin"] == 4) : ?>
                                                                <span class="badge badge-danger">ยกเลิก</span>
                                                            <?php endif; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="./#.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                                    </svg></button></a>
                                                            <!-- <a href="./?id=<?= $row["email"] ?>"><button type="button"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($row_report_outline["status_admin"] == 0) : ?>
                                                                <span class="badge badge-pill badge-danger">ยังไม่กรอกฟอร์ม</span>
                                                            <?php elseif ($row_report_outline["status_admin"] == 1) : ?>
                                                                <span class="badge badge-pill badge-warning">รอตรวจสอบ</span>
                                                            <?php elseif ($row_report_outline["status_admin"] == 2) : ?>
                                                                <span class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                            <?php elseif ($row_report_outline["status_admin"] == 3) : ?>
                                                                <span class="badge badge-warning">มีข้อมูลต้องแก้ไข</span>
                                                            <?php elseif ($row_report_outline["status_admin"] == 4) : ?>
                                                                <span class="badge badge-danger">ยกเลิก</span>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <a href="./report_outline_detail.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                                        <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                                                        <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                                                    </svg></button></a>
                                                            </svg></button></a>
