    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <form class="row g-3" action="cooperative_petition_detil_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="petition_fname" value="<?php echo isset($row['petition_fname']) ? $row['petition_fname'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-5">
                        <!-- 4	petition_lname -->
                        <label class="require" for="inputtext" class="form-label">นามสกุล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="petition_lname" value="<?php echo isset($row['petition_lname']) ? $row['petition_lname'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อหน่วยงาน" name="petition_organiztion_name" value="<?php echo isset($row['petition_organiztion_name']) ? $row['petition_organiztion_name'] : ''; ?> " disabled>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ตำแหน่ง" name="petition_position" value="<?php echo isset($row['petition_position']) ? $row['petition_position'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" class="form-control" id="phone" placeholder="094xxxxxxx" name="petition_phone" value="<?php echo isset($row['petition_phone']) ? $row['petition_phone'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-6">
                        <!-- 	12	petition_email -->
                        <label class="require" for="inputEmail4" class="form-lable">Email</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="xxxxxxxx@gmail.com" name="petition_email" value="<?php echo isset($row['petition_email']) ? $row['petition_email'] : ''; ?> " disabled>
                    </div>
                    <div class="col-md-6">
                        <!-- 13	petition_fax -->
                        <label class="require" for="inputtext" class="form-lable">เบอร์โทรสาร</label>
                        <input type="tel" class="form-control" id="phone" placeholder="094-xxx-xxxx" name="petition_fax" value="<?php echo isset($row['petition_fax']) ? $row['petition_fax'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="รหัสไปรษณีย์" name="petition_zip" value="<?php echo isset($row['petition_zip']) ? $row['petition_zip'] : ''; ?> " disabled>
                    </div>

                    <div class="col-md-12">
                        <!-- 19	petition_website -->
                        <label class="require" for="inputtext" class="form-label">เว็บไซต์ (ถ้ามี)</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="เว็บไซต์ (ถ้ามี)" name="petition_website" value="<?php echo isset($row['petition_website']) ? $row['petition_website'] : ''; ?> " disabled>
                    </div>
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ความประสงค์ฝึกสหกิจศึกษา" name="petition_wishes_to_prectice" disabled><?php echo isset($row['petition_wishes_to_prectice']) ? $row['petition_wishes_to_prectice'] : ''; ?> </textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="kv-attribute"><a href="../internship/internship_student/<?php echo $row['petition_graduation_document_file']; ?>" target="_blank" style=" color: #0d6efd;"><?php echo basename($row['petition_graduation_document_file']); ?></a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <!-- 22	petition_book -->
                        ...
                        <div class="kv-attribute"><a href="../internship/internship_student/<?php echo $row['petition_book']; ?>" target="_blank" style=" color: #0d6efd;"><?php echo basename($row['petition_book']); ?></a></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="kv-attribute"><a href="../cooperative/uploads/<?php echo $row['petition_applicant_signature_file']; ?>" target="_blank" style=" color: #0d6efd;"><?php echo basename($row['petition_applicant_signature_file']); ?></a>
                        </div>
                    </div>
                    ...
                    <form class="row g-3" action="cooperative_petition_detil_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="p-3 mb-2 bg-primary-subtle text-emphasis-primary">
                            ...
                            <div class="title" class="p-2 mb-2  text-white" class="p-3 mb-2 bg-primary-subtle text-emphasis-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16">
                            ...
                            <div class="information">
                                ...
                                <ol>
                                    <li>ผ่านรายวิชา 300202/SC002001 การเตรียมความพร้อมสหกิจศึกษา ในภาคการศึกษา
                                        ...
                                        <select class="option" id="exampleFormControlSelect1" name="petition_academic_year">
                            ...
                            <div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="ผ่านเงื่อนไข" name="petition_opinions_of_professors_type" id="flexRadioDefault1">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        ผ่านเงื่อนไข
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="ไม่ผ่านเงื่อนไข" name="petition_opinions_of_professors_type" id="flexRadioDefault2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" type="file" id="formFile" name="petition_signatore_leture_img">
                            </div>
                            ...
                            <div class="button text-right">
                                ...
                                <div class="button text-right">
                                    ...
                                    <button type="submit" id="cancel" class="btn btn-danger" data-toggle="button" name="status_admin" value="3">ไม่อนุมัติ</button>
                                </div>
                            </div>
