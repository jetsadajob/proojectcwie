...
<head>
    ...
    <link rel="stylesheet" href="./admin/assets/css/detailwork.css" <!-- Template Main CSS File -->
                    ...
                    <div class="col-md-12 d-flex ">
                        <div class="card profile-box flex-fill">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <div class="wrapper-preview-list-1 col-md-12">

                                    <strong>ประเภท : </strong> <?= $row["recruitment_type_company"]?> <br>
                                    <strong>ชื่อบริษัท/สถานประกอบการ : </strong> <?= $row["recruitment_company_name"]?>
                                    <br>
                                    ...
                                    <?= $row["recruitment_company_detail"]?>
