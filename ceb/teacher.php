<?php
include './teacherphp/DBteacher.php';
?>
        ...
        <div class="con1 row mb-2">
            ...
            <div class="col-md-9">
                ...
                <div
                    class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <h6 class="pb-1 border-bottom"><i class="bi bi-book"></i> </i>คู่มืออาจารย์การใช้งานระบบ</h6>
                        <div class="row ">
                            <div class="col-sm-12 p-1 ">
                                <div class="name-content col-md-12 pl-1 pr-1 mb-1">
                                    <a href="#"  ><i class="bi bi-filetype-doc"></i>  คู่มืออาจารย์การใช้งานระบบอาจารย์</a>
                                </div>
                            </div>
