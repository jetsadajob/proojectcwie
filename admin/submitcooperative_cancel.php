    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">   
                ...
                <div>
                <a href="./submitcooperative.php"><button type="button" class="btn btn-outline-warning">รอตรวจสอบ</button></a>
                <a href="./submitcooperative_succes.php"><button  type="button" class="btn btn-outline-success">ตรวจสอบแล้ว</button></a>
                <a href="./submitcooperative_cancel.php"><button type="button" class="btn btn-outline-danger">ไม่อนุมัติ</button></a>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM login_student RIGHT JOIN petition_document ON login_student.email = petition_document.email WHERE login_student.role = 'cooperative_student'AND petition_document.status_admin = 4";
                                ...
                                <tr>
                                    ...
                                    <td><a href="./cooperative_petition_detil.php?id=<?=$row["email"]?>"><button
                                        ...
                                        <a href="./cooperative_petition_detil_edit.php?id=<?=$row["email"]?>"><button type="button"
