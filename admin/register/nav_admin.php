         ...
         <ul class="nav user-menu">
             ...
             <input type="hidden" name="email" value="<?php echo $id; ?>">
                 ...
                 <div class="dropdown-menu">
                     ...
                     <a class="dropdown-item" href="./logout-user.php">ออกจากระบบ</a>
                 </div>
             </li>
             <!--/ ตั้งค่า โปรไฟล์ ออกจากระบบ -->
     ...
     <div class="sidebar" id="sidebar">
         <div class="sidebar-inner slimscroll">
             <div id="sidebar-menu" class="sidebar-menu">
                 ...
                 <!-- <ul>
                <li>
                    <a href="./logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-box-arrow-left " viewBox="0 0 16 16">
