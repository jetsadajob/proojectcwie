    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid mt-5">
            ...
            <div class="page-header ">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">รายละเอียดอาจารย์ที่ปรึกษา</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="addmin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">อาจารย์ที่ปรึกษา</li>
                            <li class="breadcrumb-item active">รายละเอียดอาจารย์ที่ปรึกษา</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="file-view">
                                ...
                                $sql = "SELECT * FROM login_teacher WHERE login_teacher.email = '$id' AND role='advisor'";
                                        ...
                                        <div class="col-md-12">
                                            <div class="profile-info-left">
                                                ...
                                                <h5 class="text-muted"> สาขาวิชาที่ประจำ : <?= !empty($row["major"]) ? $row["major"] : 'ยังไม่กรอกข้อมูล' ?></h>
                                                    ...
                                                    <h5 class="text-muted">ประเภทอาจารย์ : อาจารย์ที่ปรึกษา</h5>
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"><a href="#file" data-toggle="tab" class="nav-link active">รายชื่อนักศึกษา</a>
                            </li>
                                            ...
                                            <div class="col-sm-12">
                                                <table id="example" class="table table-striped" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        INNER JOIN login_teacher ON login_student.teacher_email	 = login_teacher.email 
                                                        WHERE login_teacher.email = '$id' AND login_teacher.role = 'advisor' ";
