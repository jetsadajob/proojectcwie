...
<head>
    ...
    <title>จัดการไฟล์ดาวน์โหลดดสถานประกอบการ</title>
                ...
                <div class="row align-items-center mt-5">
                    <div class="col">
                        ...
                        <ul class="breadcrumb ">
                            ...
                            <li class="breadcrumb-item active">ดาวน์โหลดสถานประกอบการ</li>
            ...
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4  shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="head-title  ">
                        <div class="left">
                            <h6 class="page-title">จัดการไฟล์ดาวน์โหลดดสถานประกอบการ</h6>
                        </div>
                    ...
                    <div class="page-header">
                        ...
                        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 mt-4 shadow-sm h-md-250 position-relative">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            class="btn btn-info btn-sm">ดาวโหลด</a> -->
                                                    ...
                                                    <a href="./downloadsdocs/delete_company.php?id=<?= $row["no"] ?>"><button type="button" class="btn btn-danger btn-sm">ลบ</button></a>
                            ...
                            if (isset($_POST['doc_name']) && $_FILES['doc_file']['name']) {
                                ...
                                $path = "./downloadsdocs/docscompany/";
                                ...
                                $stmt = $conn->prepare("INSERT INTO tbl_pdf_company (doc_name, doc_file) VALUES (:doc_name, '$filename_to_store')");
