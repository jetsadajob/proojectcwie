                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php elseif ($row_company["status_admin"] >= 5) : ?>
                                                                    <span class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                                <?php endif; ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php elseif ($row_history["status_admin"] >= 4) : ?>
                                                                    <span class="badge badge-danger">ยกเลิก</span>
                                                                <?php elseif ($row_history["status_admin"] >= 5) : ?>
                                                                    <span class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                                <?php endif; ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if ($row_certificate["status_admin"] == 0) : ?>
                                                                    <span class="badge badge-pill badge-danger">ยังไม่กรอกฟอร์ม</span>
                                                                ...
                                                                <?php elseif ($row_certificate["status_admin"] >= 4) : ?>
                                                                    <span class="badge badge-danger">ยกเลิก</span>
                                                                <?php elseif ($row_certificate["status_admin"] >= 5) : ?>
                                                                    <span class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                                <?php endif; ?>
