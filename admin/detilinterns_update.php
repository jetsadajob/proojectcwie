    ...
    if ($result) {
        ...
        setTimeout(function() {
            swal({
                ...
                window.location = "./submitinternship.php?id=' . $email . '"; // ส่งกลับไปยังหน้า detilcoop.php พร้อมกับ id
            });
        }, 1000);
    </script>';
        // header("Location: submitinternship.php?id=$email"); // ส่งกลับไปยังหน้า submitdocinternship.php
        exit;
    } else {
        echo '<script>
        setTimeout(function() {
