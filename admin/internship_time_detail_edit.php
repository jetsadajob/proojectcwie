...
RIGHT JOIN internship_time ON login_student.email = internship_time.email 
                ...
                <div class="nameform">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">รายละเอียด</li>
                            <li class="breadcrumb-item active" aria-current="page">ใบยินยอมจากผู้ปกครอง</li>
                        </ol>
                    </nav>
                    ...
                    <form action="./internship_time_update.php" method="post" id="updateform" class="form-horizontal" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <div class="kv-attribute"><a href="../internship/uploads/<?php echo $row['internship_time_file']; ?>" target="_blank" style=" color: #0d6efd;"><?php echo basename($row['internship_time_file']); ?></a></div>
                                </div>
                            </div>
