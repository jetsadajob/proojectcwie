...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <form class="row g-3" action="./coopperative_education_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-md-2">
                    ...
                    <select id="inputState" class="form-select" name="coop_report_prefix" required>
                        <option selected>-- เลือก --</option>
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="coop_report_fname" required>
                </div>

                <div class="col-md-5">
                    <!-- 5 -->
                    <label class="require" for="inputtext" class="form-label">นามสกุล</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="coop_report_lname" required>
                </div>

                <div class="col-md-6">
                    <!-- 6 -->
                    <label class="require" for="inputtext" class="form-label">รหัสนักศึกษา</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="6xxxxxxxx-x" name="coop_report_stdid" required>
                </div>

                <div class="col-md-6">
                    <!-- 7 -->
                    <label class="require" for="inputState" class="form-label">ชั้นปี</label>
                    <select id="inputState" class="form-select" name="coop_report_year_of_study" required>
                        <option selected>-- เลือก --</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="inputtext" placeholder="ชื่อหน่วยงาน" name="coop_report_company_name" required>
                </div>
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="coop_report_address" require>
                </div>

                <div class="col-md-6">
                    <!-- 10 -->
                    <label class="require" for="inputtext" class="form-label">แขวง / ตำบล</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="coop_report_subdistrict" require>
                </div>
                <div class="col-md-6">
                    <!-- 11 -->
                    <label class="require" for="inputtext" class="form-label">เขต / อำเภอ</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="coop_report_district" require>
                </div>

                <div class="col-md-6">
                    <!-- 12 -->
                    <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="coop_report_protrict" require>
                </div>
                <div class="col-md-6">
                    <!-- 13 -->
                    <label class="require" for="inputtext" class="form-label">รหัสไปรษณีย์</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="รหัสไปรษณีย์" name="coop_report_zip" require>
                </div>

                <div class="col-md-6">
                    <!-- 14 -->
                    <label class="require" for="inputtext" class="form-label">ชื่อพนักงานที่ปรึกษา</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="ชื่อพนักงานที่ปรึกษา" name="coop_report_staff_name" required>
                </div>

                <div class="col-md-6">
                    <!-- 15 -->
                    <label class="require" for="inputtext" class="form-label">ตำแหน่ง</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="ตำแหน่ง" name="coop_report_position" required>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <label class="require" for="exampleFormControlTextarea1" class="form-label">เหตุผล</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="เหตุผล" name="coop_report_reson" require></textarea>
                </div>
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="coop_report_accommodation_address" require>
                </div>

                <div class="col-md-6">
                    <!-- 29 coop_report_accommodation_subdistrict -->
                    <label class="require" for="inputtext" class="form-label">แขวง / ตำบล</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="ตำบล" name="coop_report_accommodation_subdistrict" require>
                </div>
                <div class="col-md-6">
                    <!-- 30 coop_report_accommodation_district -->
                    <label class="require" for="inputtext" class="form-label">เขต / อำเภอ</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="อำเภอ" name="coop_report_accommodation_district" require>
                </div>

                <div class="col-md-6">
                    <!-- 31 coop_report_accommodation_province -->
                    <label class="require" for="inputtext" class="form-label">จังหวัด</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="จังหวัด" name="coop_report_accommodation_province" require>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    <label class="require" for="exampleFormControlTextarea1" class="form-label">อื่นๆ</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="อื่นๆ" name="coop_report_other" require></textarea>
                </div>

                <div class="col-md-12">
                    <!-- 40 coop_report_other_suggestions -->
                    <label class="require" for="exampleFormControlTextarea1" class="form-label">ข้อเสนอแนะอื่นๆ</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="ข้อเสนอแนะอื่นๆ" name="coop_report_other_suggestions" require></textarea>
                </div>
