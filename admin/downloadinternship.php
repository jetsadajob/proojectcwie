...
<head>
    ...
    <title>จัดการไฟล์ดาวน์โหลดนักศึกษาฝึกงาน</title>
                ...
                <div class="row align-items-center mt-5">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">ดาวน์โหลดนักศึกษาฝึกงาน</li>
                ...
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="page-header">
                        ...
                        <div class="row head-title  ">
                            <div class="col ">
                                <h6 class="page-title">จัดการไฟล์ดาวน์โหลดนักศึกษาฝึกงาน</h6>
                            </div>
                        ...
                        <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- <a href="docinternship/<?= htmlspecialchars($row['doc_file']); ?>" target="_blank"
                                            class="btn btn-info btn-sm">ดาวโหลด</a> -->


                                                            <a href="./downloadsdocs/delete_internship.php?id=<?= $row["no"] ?>"><button type="button" class="btn btn-danger btn-sm">ลบ</button></a>
                            ...
                            if (isset($_POST['doc_name']) && $_FILES['doc_file']['name']) {
                                ...
                                $path = "./downloadsdocs/docinternship/";
                                ...
                                $stmt = $conn->prepare("INSERT INTO tbl_pdf_internship (doc_name, doc_file) VALUES (:doc_name, '$filename_to_store')");
