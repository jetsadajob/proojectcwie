        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid mt-5">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h5 class="fw-semibold text-center">แบบแจ้งโครงร่างรายงานการปฏิบัติงานสหกิจศึกษา (Proposal)
                            </h5>
                            <hr>
                ...
                <form class="row g-3" action="./cooperative_report_outline_update.php" id="updateform" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<div class="col-md-5">
    ...
    <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="outline_fname" value="<?php echo isset($row['std_fname']) ? $row['std_fname'] : ''; ?> " disabled>
</div>
<div class="col-md-5">
    <label for="inputtext" class="form-label">นามสกุล
    </label>
    <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="outline_lname" value="<?php echo isset($row['std_lname']) ? $row['std_lname'] : ''; ?> " disabled>
</div>
<div class="col-md-6">
    <label for="studentIdInput" class="form-label">รหัสนักศึกษา</label>
    <input type="text" class="form-control" id="studentIdInput" placeholder="6xxxxxxxx-x" name="outline_std_id" value="<?php echo isset($row['std_id']) ? $row['std_id'] : ''; ?> " disabled>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="inputZip" placeholder="รหัสไปรษณีย์" name="outline_zip" pattern="[0-9]{5}" value="<?php echo isset($row['outline_zip']) ? $row['outline_zip'] : ''; ?> " disabled>
    </div>
<div class="col-md-6">
...
<div class="col-md-12">
    <div class="uploaded-documents">
        <?php if (!empty($row['outline_work_plan_file'])) : ?>
            ...
            <a href="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_work_plan_file']); ?>" target="_blank">ดูไฟล์แผนปฏิบัติงานสหกิจศึกษา</a>
        <?php else : ?>
...
<!-- <div class="col-md-6">
    <div class="uploaded-documents">
        <?php if (!empty($row['outline_std_signature_img'])) : ?>
            ...
            <a href="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_std_signature_img']); ?>" target="_blank">ดูลายเซ็นนักศึกษา</a>
        <?php else : ?>
...
<div class="col-md-6">
        <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
            <?php if (!empty($row['outline_std_signature_img'])) : ?>
                <label for="formFile" class="form-label">ลายเซ็นนักศึกษา</label>
                <a href="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_std_signature_img']); ?>" target="_blank">
                    <img src="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_std_signature_img']); ?>" alt="รูปภาพ" style="width: 30%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                </a>
            <?php else : ?>
                <p>ไม่พบลายเซ็นนักศึกษา</p>
            <?php endif; ?>
    ...
    <div class="col-md-6">
        <div class="uploaded-documents text-left"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
            <?php if (!empty($row['outline_staff_signature_img'])) : ?>
                ...
                <a href="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_staff_signature_img']); ?>" target="_blank">
                    <img src="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_staff_signature_img']); ?>" alt="รูปภาพ" style="width: 30%; "> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                </a>
            <?php else : ?>
...
<!-- <div class="col-md-6">
        <div class="uploaded-documents">
            <?php if (!empty($row['outline_staff_signature_ime'])) : ?>
                <label for="formFile" class="form-label">ลายเซ็นพนักงานที่ปรึกษา</label>
                <a href="../cooperative/uploads/<?php echo htmlspecialchars($row['outline_staff_signature_ime']); ?>" target="_blank">ดูลายเซ็นพนักงานที่ปรึกษา</a>
            <?php else : ?>
                <p>ไม่พบลายเซ็นพนักงานที่ปรึกษา</p>
            <?php endif; ?>
        </div>
...
<button type="submit" id="submitButton" class="btn btn-success" name="status_admin" value="2" <?php if ($is_disabled) echo 'disabled'; ?>>อนุมัติ</button>
    ...
    <script src="../cooperative/script.js"></script>
</body>
