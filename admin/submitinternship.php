...
<head>
    ...
    <title>นักศึกษาที่ยื่นคำร้องฝึกงาน</title>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="submitinternship_detail.php?id=<?= urlencode($row["email"]) ?>"><button type="button" class="btn btn-outline-primary">รายละเอียด</button></a></td>
                                    </tr>
                                <?php
                                }
