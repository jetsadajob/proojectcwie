    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid mt-5">
                ...
                <form class="row g-3 needs-validation" action="internship_company_detail_update.php"  id="updateform" method="post" enctype="multipart/form-data">
                    <!-- <div class="col-md-12">
                        <h1></h1>
                    ...
                    <div class="head">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" placeholder="ชื่อผู้รับหนังสือ" name="company_detail_specity_who" value="<?php echo isset($row['company_detail_specity_who']) ? $row['company_detail_specity_who'] : ''; ?>" required readonly>
                        </div>
