...
<head>
    ...
    <title>นักศึกษาดำเนินการสมัครสหกิจศึกษา</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="head-title">
                <div class="left">
                    <h6 class="page-title">นักศึกษาดำเนินการสมัครสหกิจศึกษา</h6>
                </div>
                    ...
                    <div class="col-sm-12">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            $sql = "SELECT ls.*, cd.status_admin AS cd_status, ca.status_admin AS ca_status, cp.status_admin AS cp_status, ce.status_admin AS ce_status
                               ...
                               WHERE ls.role = 'cooperative_student' AND ls.status_end = 2 ";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($show_row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="detilcoop_success_detail_end.php?id=<?= urlencode($row["email"]) ?>"><button type="button" class="btn btn-outline-primary">รายละเอียด</button></a></td>
                                        </tr>
                                        <?php
                                    }
                                }
