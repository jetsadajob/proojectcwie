                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form class="row g-3" action="./report_evaluation_form_insert.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select id="inputState" class="form-select" name="report_prefix" value="<?php echo isset($row['std_company']) ? $row['std_company'] : ''; ?> " disabled>
                                        <option selected><?php echo isset($row['std_company']) ? $row['std_company'] : ''; ?></option>
