    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb mt-5">
                            ...
                            <li class="breadcrumb-item active">การดำเนินการยื่นคำร้องฝึกงาน</li>
                        </ul>
                    </div>
            ...
            <div class="head-title">
                <div class="left">
                    <h6 class="page-title">นักศึกษาดำเนินการสมัครฝึกงาน</h6>
                </div>
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <?php
                                $sql = "SELECT ls.*, cd.status_admin AS cd_status, ib.status_admin AS ib_status, 
                                        ic.status_admin AS ic_status, sh.status_admin AS sh_status , it.status_admin AS it_status
                                        ...
                                        LEFT JOIN internship_time  it ON sh.email = it.email
                                        WHERE ls.role = 'internship_student' AND ls.status_end = 2"; // ตรวจสอบว่า status_end = 1
                                $result = mysqli_query($conn, $sql);

                                while ($row = mysqli_fetch_array($result)) {
                                    // ตรวจสอบสถานะในแต่ละตาราง
                                    $is_all_approved = ($row['cd_status'] == 2) && ($row['ib_status'] == 2) && 
                                                    ($row['ic_status'] == 2) && ($row['sh_status'] == 2) && ($row['it_status'] == 2); // ตรวจสอบว่า status_admin = 2 ในทุกตาราง
                                    ...
                                    if ($is_all_approved) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="submitdocinternship_detail_end.php?id=<?= urlencode($row["email"]) ?>"><button type="button" class="btn btn-outline-primary">ดูรายละเอียด</button></a></td>
                                        </tr>
                                        <?php
                                    }
                                }
