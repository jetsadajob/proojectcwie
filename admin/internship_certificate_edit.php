...
RIGHT JOIN internship_certificate ON login_student.email = internship_certificate.email 
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid mt-5">
                ...
                <div class="nameform">
                    ...
                    <form action="./internship_certificate_update.php" id="updateform" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <!-- <hr> -->
                        <div class="mb-3">
                            <div class="box-body">
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <div class="kv-attribute"><a href="../internship/uploads/<?php echo $row['internship_certificate_file']; ?>" target="_blank" style=" color: #0d6efd;"><?php echo basename($row['internship_certificate_file']); ?></a></div>
                                        </div>
                                    </div>
