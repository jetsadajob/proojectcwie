                                    ...
                                    <div class="page-header">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                $sql_student = "SELECT * FROM internship_parental_consent_form WHERE email ='$id' ";
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="./internship_company_print.php?id=<?= $row["email"] ?>"><button class="btn btn-outline-success" style="border-radius: 7px;"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php elseif ($row_student["status_admin"] == 1) : ?>
                                                                    <span style="color: rgb(251, 180, 48);">รอตรวจสอบ</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="./internship_history_print.php?id=<?= $row["email"] ?>"><button class="btn btn-outline-success" style="border-radius: 7px;"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                                                                            <path d="M5 1a2 2 0 0 0-2 2v1h10V3a2 2 0 0 0-2-2zm6 8H5a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1" />
                                                                            <path d="M0 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-1v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2H2a2 2 0 0 1-2-2zm2.5 1a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1" />
                                                                        </svg></button></a>
                                                            </td>
            ...
            <div class="tab-content">
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php elseif ($row_time["status_admin"] == 1) : ?>
                                                                    ...
                                                                    <?php elseif ($row_time["status_admin"] == 4) : ?>
                                                                        <span class="badge badge-danger">ยกเลิก</span>
                                                                    <?php elseif ($row_time["status_admin"] == 5) : ?>
                                                                        <span class="badge badge-pill badge-success">ตรวจสอบแล้ว</span>
                                                            ...
                                                            <td>
                                                                <a href="./internship_time_detail.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                                                            <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                                                        </svg></button></a>
                                                                </svg></button></a>
                                                                <a href="./internship_time_detail_edit.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                                        </svg></button></a>
                                                                <!-- <a href="./?id=<?= $row["email"] ?>"><button type="button"
                ...
                <form action="./submitdocinternship_update.php" method="post">
                                    <div class="button text-right">
                                        ...
                                        <!-- เพิ่ม input ที่ซ่อนไว้สำหรับ status_end -->
                                        <input type="hidden" name="status_end" value="2">
                                        <button type="submit" id="submit" class="btn btn-success" name="status_admin" value="2">ยืนยันการตรวจสอบ</button>
                                        <a href="submitdocinternship.php"><button type="button" class="btn btn-danger">ยกเลิก</button></a>
                                    </div>
                                </form>
            </div>
