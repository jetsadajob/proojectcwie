...
<head>
    ...
    <title>จัดการไฟล์ดาวน์โหลดดนักศึกษาสหกิจศึกษา</title>
    <!-- รูปโปรไฟล์ -->
                ...
                <div class="row align-items-center ">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item ">จัดการดาวน์</li>
                            <li class="breadcrumb-item active">ดาวน์โหลดนักศึกษาสหกิจ</li>
                ...
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="page-header">
                        ...
                        <div class="row head-title  ">
                            ...
                            <div class="col ">
                                <h6 class="page-title">จัดการไฟล์ดาวน์โหลดดนักศึกษาสหกิจศึกษา</h6>
                            </div>
                        ...
                        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 mt-4 shadow-sm h-md-250 position-relative">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            class="btn btn-info btn-sm">ดาวโหลด</a> -->
                                                    ...
                                                    <a href="./downloadsdocs/delete_coop.php?id=<?= $row["no"] ?>"><button type="button" class="btn btn-danger btn-sm">ลบ</button></a>
                            ...
                            if (isset($_POST['doc_name']) && $_FILES['doc_file']['name']) {
                                ...
                                $stmt = $conn->prepare("INSERT INTO tbl_pdf_coop (doc_name, doc_file) VALUES (:doc_name, '$filename_to_store')");
                                    ...
                                    echo '<script>
                                        setTimeout(function() {
                                            swal({
                                                ...
                                                window.location = "downloadcoop.php";
                                            });
                                        }, 1000);
                                    </script>';
                                } else {
