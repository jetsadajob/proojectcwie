    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb mt-5">
                            ...
                            <li class="breadcrumb-item ">แบบฟอร์มฝึกงาน</li>
                            <li class="breadcrumb-item active">นักศึกษาที่ยื่นคำร้องฝึกงาน</li>
                            <li class="breadcrumb-item active">ตรวจสอบเเล้ว</li>
            ...
            <div class="head-title">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="./submitinternship.php"><button type="button" class="btn btn-outline-primary">รอตรวจสอบ</button></a>

                    <a href="./submitinternship_success.php"><button type="button" class="btn btn-outline-primary">ตรวจสอบแล้ว</button></a>
                </div>
        ...
        WHERE ls.role = 'internship_student' AND ls.status_end = 1";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    // ตรวจสอบว่าสถานะในแต่ละตารางทั้งหมดได้รับการอนุมัติหรือไม่
                                    $is_all_approved = ($row['cd_status'] == 2) && ($row['ib_status'] == 2) && ($row['ic_status'] == 2) && ($row['sh_status'] == 2);
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a href="./detilinterns_success.php?id=<?= urlencode($row["email"]) ?>"><button type="button" class="btn btn-outline-primary">รายละเอียด</button></a></td>
                                        </tr>
                                <?php
                                    }
                                }
