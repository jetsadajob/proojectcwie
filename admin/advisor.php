        ...
        <div class="page-wrapper">
            ...
            <div class="page-header">
                ...
                <div class="head-title">
                    <div class="left">
                        <h6 class="page-title">รายชื่ออาจารย์ที่ปรึกษา</h6>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                            <?php
                                    $sql = "SELECT * FROM login_teacher WHERE role = 'advisor' ";
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row["major"]?></td>
                                        <td><?= $row["email"]?></td>
                                        <td><a href="detailadvisor.php?id=<?=$row["email"]?>"><button type="button" class="btn btn-outline-primary">ดูรายละเอียด</button></a></td>
                                    </tr>
