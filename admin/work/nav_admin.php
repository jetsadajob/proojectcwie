...
$ins = $pdo->prepare(
    "SELECT COUNT(*) FROM petition_document
        LEFT JOIN coop_application_form ON petition_document.email = coop_application_form.email
        LEFT JOIN coopperative_perental_consent_form ON petition_document.email = coopperative_perental_consent_form.email
        LEFT JOIN student_acceptance_form ON petition_document.email = student_acceptance_form.email
        
        WHERE petition_document.status_admin != 2 
        OR coop_application_form.status_admin != 2 
        OR coopperative_perental_consent_form.status_admin != 2 
        OR student_acceptance_form.status_admin != 2"
);


$ins->execute();
$unapprovedCount1 = $ins->fetchColumn();
...
$ins = $pdo->prepare(
    "SELECT COUNT(*) FROM company_detail
        LEFT JOIN student_history ON company_detail.email = student_history.email
        LEFT JOIN internship_parental_consent_form
 ON company_detail.email = internship_parental_consent_form
.email
        LEFT JOIN internship_certificate ON company_detail.email = internship_certificate.email
        
        WHERE company_detail.status_admin != 2 
        OR internship_parental_consent_form
.status_admin != 2 
        OR student_history.status_admin != 2 
        OR internship_certificate.status_admin != 2"
);


$ins->execute();
$unapprovedCount2 = $ins->fetchColumn();
    ...
    <div class="header">
        ...
        <div class="header-left ">
            <a href="./addmin.php" class="logo text-decoration-none">
                <img src="./assets/img/profiles/logo.png" width="" height="60" alt="">
        ...
        <ul class="nav user-menu">
            ...
            <!-- <li class="nav-item dropdown no-arrow mx-1">
                 ...
                 <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                     ...
                     <a class="dropdown-item text-center small text-gray-500" href="#">แสดงทั้งหมด</a>
                 </div> -->
            </li>
