...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../internship/assets/css/bootstrap.min.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">

    <!-- Lineawesome CSS -->
    <link rel="stylesheet" href="../internship/assets/css/line-awesome.min.css">
            ...
            <form class="row g-3" action="./internship_history_update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="uploaded-documents text-center"> <!-- เพิ่ม class text-center เพื่อจัดให้อยู่ตรงกลาง -->
                        <?php if (!empty($row['std_history_profile_img'])) : ?>
                            ...
                            <a href="../internship/uploads/<?php echo htmlspecialchars($row['std_history_profile_img']); ?>" target="_blank">
                                <img src="../internship/uploads/<?php echo htmlspecialchars($row['std_history_profile_img']); ?>" alt="รูปภาพ" style="width: 1in; height: auto;"> <!-- กำหนดขนาดของรูปภาพเป็น 1 นิ้ว -->
                            </a>
                        <?php else : ?>
                            <p>ไม่พบรูปภาพ</p>
                        <?php endif; ?>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-5">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="ชื่อ" name="std_history_fname" value="<?php echo isset($row['std_fname']) ? $row['std_fname'] : ''; ?> " disabled>
                    </div>

                    <div class="col col-md-5">
                        <label for="inputtext" class="form-label">นามสกุล</label>
                        <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="std_history_lname" value="<?php echo isset($row['std_lname']) ? $row['std_lname'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="6xxxxxxxx-x" name="std_history_std_id" value="<?php echo isset($row['std_id']) ? $row['std_id'] : ''; ?> " disabled>
                    </div>
                    ...
                    <div class="col col-md-6">
                        ...
                        <select id="inputState" class="form-select" name="std_history_field_of_study" disabled>
                            <option><?php echo isset($row['major']) ? $row['major'] : ''; ?></option>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-6">
                        ...
                        <input type="date" class="form-control" id="std_history_birthday" name="std_history_birthday" value="<?php echo isset($row['std_birthday']) ? $row['std_birthday'] : ''; ?> " disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputtext" placeholder="อายุ" name="std_history_age" value="<?php echo isset($row['std_age']) ? $row['std_age'] : ''; ?> " disabled>
                    </div>
                    <div class="col col-md-6">
