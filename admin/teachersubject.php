...
<head>
    ...
    <title>รายชื่ออาจารย์ประจำวิชา</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center mt-5">
                    <div class="col">
                        ...
                        <ul class="breadcrumb ">
                            ...
                            <li class="breadcrumb-item active">อาจารย์ประจำวิชา</li>
                        </ul>
                    </div>
            ...
            <div class="head-title">
                <div class="left">
                    <h6 class="page-title">รายชื่ออาจารย์ประจำวิชา</h6>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM login_teacher WHERE role = 'course_instructor' ";
                                ...
                                ?>
                                    ...
                                    <td><?= $row["prefix"] ?> <?= $row["name"] ?></td>
                                        ...
                                        <td><?= $row["major"] ?></td>
                                        <td><?= $row["email"] ?></td>
                                        <td><a href="detailcourse_instructor.php?id=<?= $row["email"] ?>"><button type="button" class="btn btn-outline-primary">ดูรายละเอียด</button></a></td>
                                    </tr>
