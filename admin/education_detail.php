...
RIGHT JOIN coopperative_education_report_form ON login_student.email = coopperative_education_report_form.email 
            ...
            <form class="row g-3" action="./coopperative_education_insert.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-md-2">
                    ...
                    <select id="inputState" class="form-select" name="coop_report_prefix" disabled>
                        <option><?php echo isset($row['coop_report_prefix']) ? $row['coop_report_prefix'] : ''; ?></option>
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" id="inputtext" placeholder="นามสกุล" name="coop_report_lname" value="<?php echo isset($row['coop_report_lname']) ? $row['coop_report_lname'] : ''; ?> " disabled>
                </div>

                <div class="col-md-6">
                    <!-- 6 -->
                    <label class="require" for="inputtext" class="form-label">รหัสนักศึกษา</label>
                    <input type="text" class="form-control" id="inputtext" placeholder="6xxxxxxxx-x" name="coop_report_stdid" value="<?php echo isset($row['coop_report_stdid']) ? $row['coop_report_stdid'] : ''; ?> " disabled>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select id="inputState" class="form-select" name="coop_report_year_of_study" disabled>
                        <option><?php echo isset($row['coop_report_year_of_study']) ? $row['coop_report_year_of_study'] : ''; ?></option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputtext" placeholder="รหัสไปรษณีย์" name="coop_report_zip" value="<?php echo isset($row['coop_report_zip']) ? $row['coop_report_zip'] : ''; ?> " disabled>
                </div>
                ...
                <!-- <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="male" name="coop_report_date_start" value="<?php echo isset($row['coop_report_date_start']) ? $row['coop_report_date_start'] : ''; ?> " disabled>
                </div> -->
                <!-- 17 -->
                <!-- <div class="col-md-6">
                    <label class="require" for="male" class="form-lable">วันที่สิ้นสุด</label>
                    <input type="date" class="form-control" id="male" name="coop_report_date_end" value="<?php echo isset($row['coop_report_date_end']) ? $row['coop_report_date_end'] : ''; ?> " disabled>
                </div> -->
                <hr>
