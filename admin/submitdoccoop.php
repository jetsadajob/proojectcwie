...
<head>
    ...
    <title>ติดตามการดำเนินการนักศึกษาสหกิจศึกษา</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center mt-5">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">ติดตามการดำเนินการนักศึกษาสหกิจศึกษา</li>
            ...
            <div class="head-title">
                <div class="left">
                    <h6 class="page-title">ติดตามการดำเนินการนักศึกษาสหกิจศึกษา</h6>
                </div>

                <div class="col-auto float-right ml-auto">
                    <!-- <a href="submitdoccoop.php"><button type="button" class="btn btn-outline-primary">สหกิจศึกษา</button></a> -->
                    <!-- <a href="submitdoccoop_end.php"><button  type="button" class="btn  btn-outline-primary">สินสุดสหกิจศึกษา</button></a> -->
                               ...
                               WHERE ls.role = 'cooperative_student' AND ls.status_end = 1  ";
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="detilcoop_success2.php?id=<?= urlencode($row["email"]) ?>"><button type="button" class="btn btn-outline-primary">รายละเอียด</button></a></td>
                                        </tr>
                                <?php
                                    }
                                }
