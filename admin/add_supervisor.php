                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form onsubmit="return validateAddsupervisorForm()" action="./add_supervisor/add_supervisor_insert.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            ...
                                            <select name="company_name" id="company_name" class="form-control" onchange="selectCompanyAndStudents()">
                                                ...
                                                <option value="" name="company_name" id="company_name" class="form-control" selected="selected">-- กรุณาเลือก --</option>
                                                <?php
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            ที่อยู่
                                            <input type="text" id="company_address" name="company_address" class="form-control" minlength="5" maxlength="20" required>
                                        </div>
                                        <div class="col">
                                            ตำบล/แขวง
                                            <input type="text" id="company_subdistrict" name="company_subdistrict" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            อำเภอ/เขต
                                            <input type="text" id="company_district" name="company_district" class="form-control" minlength="5" maxlength="20" required>
                                        </div>
                                        <div class="col col-sm-6">
                                            จังหวัด
                                            <input type="text" id="company_province" name="company_province" class="form-control" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col col-sm-6">
                                            รหัสไปรษณีย์
                                            <input type="text" id="company_zip" name="company_zip" class="form-control" minlength="5" maxlength="20" required>
                                        </div>

                                        <div class="col col-sm-6">
                                            วันที่ออกนิเทศ
                                            <input type="date" name="date_supervision" class="form-control" minlength="5" maxlength="20" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            อาจารย์นิเทศคนที่ 1
                                            <select name="supervisor_1" id="supervisor_1" class="form-select" required>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped" style="width:100%">
                                                    ...
                                                    <tbody id="studentTableBody">
                                                        <?php
                                                        $sql_students = "SELECT * FROM petition_document ";

                                                        $result_students = mysqli_query($conn, $sql_students);

                                                        if ($result_students) {
                                                            while ($row = mysqli_fetch_array($result_students)) {
                                                                if (!empty($row["petition_lname"]) && !empty($row["petition_field_of_study"]) && !empty($row["petition_organiztion_name"])) {
                                                        ?>
                                                                    <tr>
                                                                        <td><input type="checkbox" class="checkItem" name="selected_students[]" value="<?= $row["petition_fname"] ?>"></td>
                                                                        <td name="std_fname"><?= $row["petition_fname"] ?> </td>
                                                                        <td name="std_lname"><?= $row["petition_lname"] ?> </td>
                                                                        <td name="std_major"><?= $row["petition_field_of_study"] ?></td>
                                                                        <td name="std_email"><?= $row["email"] ?></td>
                                                                        <td><?= $row["petition_organiztion_name"] ?></td>
                                                                    </tr>
                                                        <?php
                                                                }
                                                            }
