            ...
            if ($row && isset($row['name'])) {
                ...
                if ($role == "internship_student") {
                    ...
                    if ($insert_stmt->execute()) {
                        ...
                        $update_email_stmt = $db->prepare("INSERT INTO supervision_recording (email) VALUES (:uemail)");
                        $update_email_stmt->bindParam(":uemail", $email);
                        $update_email_stmt->execute();

                        $update_email_stmt = $db->prepare("INSERT INTO coopperative_information (email) VALUES (:uemail)");
                        $update_email_stmt->bindParam(":uemail", $email);
                        $update_email_stmt->execute();

                        $update_email_stmt = $db->prepare("INSERT INTO performance_appraisal_form (email) VALUES (:uemail)");
                        $update_email_stmt->bindParam(":uemail", $email);
                        $update_email_stmt->execute();
                 
                        $update_email_stmt = $db->prepare("INSERT INTO  (email) VALUES (:uemail)");
                        $update_email_stmt->bindParam(":uemail", $email);
                        $update_email_stmt->execute();
