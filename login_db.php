<?php
    ...
    if(isset($_POST['btn_login'])) {
        ...
        if (empty($email)) {
            ...
            try{
                $select_stmt = $db->prepare("SELECT email, password, role FROM login_student WHERE email = :uemail AND password = :upassword AND role = :urole");
                        ...
                        if ($email == $dbemail AND $password == $dbpassword AND $role == $dbrole) {
                            switch($dbrole){
                                ...
                                case 'cooperative_student':
                                    ...
                                    header("location: ./cooperative/cooperative_student/cooperative_student_home.php");
                                    break;
