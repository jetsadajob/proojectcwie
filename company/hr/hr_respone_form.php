    ...
    ?>
        ...
        <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">จัดการแบบตอบรับนักศึกษา</li>
                    </ol>
                </nav>
            <!-- ส่วนของข้อมูล -->
                                ...
                                <table class="table table-striped  table-hover table-responsive table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="./form_hr.php"><button type="button"
                                                        class="btn btn-outline-primary">รายละเอียด</button></a>
