...
<head>
    ...
    <title>แบบตอบรับนักศึกษาในประเทศ</title>
            ...
            <div class="content container-fluid">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">แบบตอบรับนักศึกษาในประเทศ</li>
                    </ol>
                </nav>
                <div class="nameform">
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="text-center">รายละเอียดแบบตอบรับนักศึกษาในประเทศ</h5>
                    ...
                    <div class="text-end">
                        <a href="./student_acceptance_form.php">
                            <button type="button" class="btn btn-outline-primary">ทำแบบประเมิน</button>
                        </a>
                    </div>
                    <br>
                    ...
                    <table id="example" class="table" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <!-- <td><a href="./KKUCP-T002.php"><button type="button" class="btn btn-outline-primary">ทำแบบประเมิน</button></a></td> -->
                            </tr>
                            <tr>
                                <td>2</td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <!-- <td><a href="./KKUCP-T004.php"><button type="button" class="btn btn-outline-primary">ทำแบบประเมิน</button></a></td> -->
                            </tr>
                        </tbody>
                    </table>
                </div>
