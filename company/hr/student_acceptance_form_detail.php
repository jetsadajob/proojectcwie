...
$sql = "SELECT * FROM student_acceptance_form"; //เช็คเงื่อนไขที่ส่งมา
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form class="row g-3" action="./student_acceptance_form_insert" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexRadioDefault1" value="ไม่สามารถรับนักศึกษาเข้าปฏิบัติงานได้" <?php echo (isset($row['acceptance_status_type']) && $row['acceptance_status_type'] == 'แนะนำให้นักศึกษารุ่นต่อไปมาอีก') ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexRadioDefault2" value="ยินดีรับ" <?php echo (isset($row['acceptance_status_type']) && $row['acceptance_status_type'] == 'แนะนำให้นักศึกษารุ่นต่อไปมาอีก') ? 'checked' : ''; ?>>
                                            ยินดีรับ
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="file" id="formFile" name="acceptance_signature_img" value="<?php echo isset($row['acceptance_signature_img']) ? $row['acceptance_signature_img'] : ''; ?> " disabled>
                                </div>
                                <br>
                                <div class="button">
