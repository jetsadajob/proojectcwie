...
?>
        ...
        <div class="page-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="course_instructor_home.php">หน้าหลัก</a></li>
                    <li class="breadcrumb-item active">ตรวจสอบใบคำร้องขอเข้าร่วมโครงการสหกิจศึกษา</li>
                    ...
                    <div class="row user-tabs">
                        <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                            <ul class="nav nav-tabs nav-tabs-bottom">
                                <li class="nav-item"><a href="#file" data-toggle="tab"
                                        class="nav-link active">เอกสาร</a>
                                </li>
                                <!-- <li class="nav-item"><a href="#course" data-toggle="tab" class="nav-link">อาจารย์ประจำรายวิชา</a>
                            </li> -->
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <!-- <form action=""> -->
                                    <h5 class="card-title">การดำเนินการสมัครสหกิจศึกษา</h5>
                                    <div class="page-header">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <?php
                                                ...
                                                <table class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th>ลำดับ</th>
                                                            <th>ชื่อแบบฟอร์ม</th>
                                                            <th>สถานะ (อาจารย์ประจำรายวิชา)</th>
                                                            <th>รายละเอียด</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="badge badge-pill badge-warning">รอตรวจสอบ</span><span
                                                            ...
                                                            <td>
                                                                <!-- <a
                                                                    href="./coop_petition_detail.php?id=<?= $row["email"] ?>"><button
                                                                        type="button"
                                                                ...
                                                                <a
                                                                    href="./cooperative_petition_detil_edit.php?id=<?= $row["email"] ?>"><button
                                                                        type="button"
...
?>
                                ...
                                <form action="./detailcoop_update.php" method="post">
                                    <div class="button text-right ">
                                        <!-- แก้ไขลิงก์เป็นปุ่ม submit -->
                                        <input type="hidden" name="email" value="<?= $row["email"] ?>">
                                        <button type="submit" id="submit" class="btn btn-success" name="status_admin"
                                            value="1">ยืนยันการตรวจสอบ</button>
