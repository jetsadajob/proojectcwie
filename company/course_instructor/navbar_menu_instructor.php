                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <span class="user-img"><img src="../assets/img/user.jpg" alt="">
                            <span>สถานะ : อาจารย์ประจำรายวิชา</span>
                    </a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a class="text-decoration-none" href="course_instructor_home.php"><svg
                        ...
                        <li>
                            <a class="text-decoration-none" href="liststdcoop.php"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <span>ตรวจสอบใบคำร้อง</span></a>
                        </li>

                        <!-- <li>
                            <a class="text-decoration-none" href="student.php" class="noti-dot"><svg
                        ...
                        <!-- <li>
                            <a class="text-decoration-none" href="hr_respone_form.php"><svg
                                    xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
                                    <path
                        ...
                        <!-- <li>
                            <a class="text-decoration-none" href="student.php">
