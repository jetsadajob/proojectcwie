            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        รายละเอียดการตรวจสอบใบคำร้องขอเข้าร่วมโครงการสหกิจศึกษา</li>
                </ol>
            </nav>
            <!-- ส่วนของข้อมูล -->
            <div class="content container-fluid">
                ...
                <div class="nameform">
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="text-center">รายละเอียดการตรวจสอบใบคำร้องขอเข้าร่วมโครงการสหกิจศึกษา</h5>
                                <div class="text-center">เจษฎา เสงี่ยมสูงเนิน : นักศึกษาฝึกงาน</div>
                            </div>
                        </div>
                    </div><br>
